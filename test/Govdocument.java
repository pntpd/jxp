                ...
                try
                {
                    ...
                    for(int i = 3; i < rowCount; i++)
                    {
                        ...
                        if(rowData != null)
                        {
                            ...
                            {
                                String name = "", docname = "", docno = "", dateofissue = "" , expirydate= "", placeofissue= "",  documentissuedby= "";
                                int candidateid = 0 , id = 0, doctypeid = 0;
                                try
                                {
                                ...
                                try
                                {
                                    docname = rowData[j].getContents() != null ? rowData[j].getContents().trim() : "";
                                ...
                                try
                                {
                                    placeofissue = rowData[j].getContents() != null ? rowData[j].getContents().trim() : "";
                                    j++;
                                }
                                catch(Exception e){j++;}
                                try
                                {
                                    documentissuedby = rowData[j].getContents() != null ? rowData[j].getContents().trim() : "";
                                    j++;
                                }
                                catch(Exception e){j++;}
                        ...
                        if(docname != "" && !docname.equals(""))
                        {
                             ...
                             if(id != 0)
                            {
                                    ...
                                    pstmt.close();
                                     ...
                                     String doctypequery = "select i_doctypeid from t_doctype where s_doc = ? ";
                              ...
                              if(candidateid != 0)
                            {
                                    ...
                                    sb.append("(i_doctypeid,s_docno, d_dateofissue,d_expirydate,s_placeofissue,s_documentissuedby, i_candidateid, i_status, ts_regdate,ts_moddate ) ");
                                    sb.append("values (?,?,?,?,?,?,?,?,?,?)");
                                    ...
                                    sb.setLength(0);
                                            ...
                                            pstmt.setString(3, base.changeDate5(dateofissue));
                                            pstmt.setString(4, base.changeDate5(expirydate));
                                            pstmt.setString(5, placeofissue);
                                            pstmt.setString(6,documentissuedby);
                                            pstmt.setInt(7, candidateid);
                                            pstmt.setInt(8, 1);
                                            pstmt.setString(9, base.currDate1());
                                            pstmt.setString(10, base.currDate1());
