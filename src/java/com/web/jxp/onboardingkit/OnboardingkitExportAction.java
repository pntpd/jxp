...
public class OnboardingkitExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = onboardingkit.getListForExcel(search);
            int total = list.size();  
            String fileName = "Onboardingkit_Report";
            ...
            {
                OnboardingkitInfo info = (OnboardingkitInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  onboardingkit.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                  
                }
                info = null;
            }
