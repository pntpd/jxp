...
public class CountryExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = country.getListForExcel(search);
            int total = list.size();  
            String fileName = "Country_Report";
            ...
            {
                CountryInfo info = (CountryInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  country.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                   
                }
                info = null;
        }
