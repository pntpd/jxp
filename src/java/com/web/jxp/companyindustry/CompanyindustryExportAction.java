...
public class CompanyindustryExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = company.getExcel(search);
            int total = list.size();  
            String fileName = "Companyindustry_excel_report";
            ...
            {
                CompanyindustryInfo info = (CompanyindustryInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(company.getStatusById(info.getStatus()));
                    cell.setCellStyle(contentstyle);
                }
                info = null;
            }
