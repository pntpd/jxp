...
public class RelationExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = relation.getListForExcel(search);
            int total = list.size();  
            String fileName = "Relation_Report";
            ...
            {
                RelationInfo info = (RelationInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  relation.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);               
                }
                info = null;
            }
