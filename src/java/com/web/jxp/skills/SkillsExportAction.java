...
public class SkillsExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = skills.getListForExcel(search);
            int total = list.size();  
            String fileName = "Skills_Report";
            ...
            {
                SkillsInfo info = (SkillsInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  skills.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);         
                }
                info = null;
            }
