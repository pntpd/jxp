...
public class BloodpressureExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = bloodpressure.getListForExcel(search);
            int total = list.size();  
            String fileName = "Bloodpressure_Report";
            ...
            {
                BloodpressureInfo info = (BloodpressureInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  bloodpressure.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);          
                }
                info = null;
            }
