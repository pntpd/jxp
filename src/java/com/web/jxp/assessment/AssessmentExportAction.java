...
public class AssessmentExportAction extends Action
{
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = assessment.getListForExcel(search, assessmentparameterIndex, questiontypeIndex);
            int total = list.size();  
            ...
            {
                AssessmentInfo info = (AssessmentInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell.setCellValue(assessment.changeNum(info.getAssessmentId(),3));
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getMode()!= null ? info.getMode(): "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getParaName()!= null ? info.getParaName() : "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(assessment.getStatusById( info.getStatus()));
                    cell.setCellStyle(contentstyle);                            
                }
                info = null;
        }
