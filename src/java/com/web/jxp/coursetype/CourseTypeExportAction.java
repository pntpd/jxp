...
public class CourseTypeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = coursetype.getListForExcel(search);
            int total = list.size();  
            String fileName = "CourseType_Report";
            ...
            {
                CourseTypeInfo info = (CourseTypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  coursetype.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);              
                }
                info = null;
            }
