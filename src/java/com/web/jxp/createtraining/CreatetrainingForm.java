...
public class CreatetrainingForm extends ActionForm
{
    ...
    private int type;
    private FormFile elearningfile;
    private String efilehidden;
     ...
     */
    public FormFile getElearningfile() {
        return elearningfile;
    }

    /**
     * @param elearningfile the elearningfile to set
     */
    public void setElearningfile(FormFile elearningfile) {
        this.elearningfile = elearningfile;
    }

    /**
     * @return the efilehidden
     */
    public String getEfilehidden() {
        return efilehidden;
    }

    /**
     * @param efilehidden the efilehidden to set
     */
    public void setEfilehidden(String efilehidden) {
        this.efilehidden = efilehidden;
    }
}