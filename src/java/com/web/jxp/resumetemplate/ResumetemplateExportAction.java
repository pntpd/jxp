...
public class ResumetemplateExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = resumetemplate.getListForExcel(search, allclient,  permission,  cids,  assetids);
            int total = list.size();  
            String fileName = "Resumetemplate_Report";
            ...
            {
                ResumetemplateInfo info = (ResumetemplateInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  resumetemplate.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                                          
                }
                info = null;
            }
