...
public class AssessmentParameterExportAction extends Action 
{
    @Override
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        try 
        {
            ...
            ArrayList list = assessmentParameter.getListForExcel(search);
            int total = list.size();
            String fileName = "AssessmentParameter_Report";
            ...
            {
                AssessmentParameterInfo info = (AssessmentParameterInfo) list.get(i);
                if (info != null)
                {
                    col = 0;
                    ...
                    cell.setCellValue(assessmentParameter.changeNum(info.getAssessmentParameterId(), 3));
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ? assessmentParameter.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);
                }
                info = null;
            }
