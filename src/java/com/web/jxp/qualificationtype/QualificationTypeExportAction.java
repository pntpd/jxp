...
public class QualificationTypeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = qualificationtype.getListForExcel(search);
            int total = list.size();  
            String fileName = "QualificationType_Report";
            ...
            {
                QualificationTypeInfo info = (QualificationTypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  qualificationtype.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                 
                }
                info = null;
            }
