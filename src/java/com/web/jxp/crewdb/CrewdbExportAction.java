...
public class CrewdbExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = crewdb.getListForExcel(search, positionIndex, clientIdIndex, countryIdIndex, assetIdIndex);
            int total = list.size();  
            String fileName = "Crewdb_Report";
            ...
            {
                CrewdbInfo info = (CrewdbInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell.setCellValue(crewdb.changeNum(info.getCrewdbId(), 4));
