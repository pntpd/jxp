...
public class StateExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = state.getExcel(search);
            int total = list.size();  
            String fileName = "State_excel_report";
            ...
            {
                StateInfo info = (StateInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStateName()!= null ? info.getStateName(): "");
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(state.getStatusById(info.getStatus()));
                    cell.setCellStyle(contentstyle);
                }
                info = null;
            }
