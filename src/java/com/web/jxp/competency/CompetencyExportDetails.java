...
public class CompetencyExportDetails extends Action
{        
    @Override
    ...
    { 
       try
        {            
                ...
                if(request.getSession().getAttribute("COMP_NAMELIST") != null)
                    list = (ArrayList) request.getSession().getAttribute("COMP_NAMELIST"); 
                int total = list.size();

                String fileName = "Role_Competency_Report";
                ...
                cell = row.createCell(c);
                cell.setCellValue("Expiry in Days");
                sheet.setColumnWidth(c, 256*30);
                cell.setCellStyle(headstyle);
                c++;
                ...
                for(int i = 0; i < total;i++)
                {
                    ...
                    {                    
                        ...
                        cell = row.createCell(col++);
                        cell.setCellValue(info.getDateDiff());
                        cell.setCellStyle(contentstyle);
