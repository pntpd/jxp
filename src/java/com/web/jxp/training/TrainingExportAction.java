...
public class TrainingExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = training.getExcel(search, allclient, permission, cids, assetids,clientIndex,assetIndex );
            int total = list.size();  
            String fileName = "Training_Report";
            ...
            {
                TrainingInfo info = (TrainingInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  training.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                    
                }
                info = null;
            }
