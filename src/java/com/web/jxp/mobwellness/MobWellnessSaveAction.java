...
public class MobWellnessSaveAction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int sss = 0;
        String wellnessIds = jsonRequest.optString("wellnessId", "0");
        ...
        int wellnessId = Integer.parseInt(wellnessIds);
        ...
        if (userId > 0 && wellnessId > 0 && (dailyStep > 0 || (sleepTime != null && !sleepTime.isEmpty()) || (wakeupTime != null
                && !wakeupTime.isEmpty()) || sleepHour > 0 || activityHour > 0 || standHour > 0)) {
            int cc = crewlogin.doSaveWellnessDetails(wellnessId, dailyStep, sleepTime, wakeupTime, sleepHour, activityHour, standHour,
                    userId);
            if (cc > 0) {
