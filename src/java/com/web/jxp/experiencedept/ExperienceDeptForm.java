...
public class ExperienceDeptForm extends ActionForm
{
    ...
    /**
     * @param experiencedeptId the experiencedeptId to set
     */
    public void setExperiencedeptId(int experiencedeptId) {
