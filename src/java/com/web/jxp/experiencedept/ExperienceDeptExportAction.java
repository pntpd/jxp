...
public class ExperienceDeptExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = experiencedept.getListForExcel(search);
            int total = list.size();  
            String fileName = "ExperienceDept_Report";
            ...
            {
                ExperienceDeptInfo info = (ExperienceDeptInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  experiencedept.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                
                }
                info = null;
            }
