...
public class CompetencyprioritiesExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = competencypriorities.getExcel(search, departmentId, clientIdIndex, assetIdIndex); 
            int total = list.size();  
            String fileName = "Competencypriorities_excel_report";
            ...
            cell = row.createCell(c);
            cell.setCellValue("Competency Priority ");
            ...
            {
                CompetencyprioritiesInfo info = (CompetencyprioritiesInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(competencypriorities.getPrioritDegreeById(info.getDegreeId()));
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getDeptColumn()!= null ? info.getDeptColumn(): "");
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(competencypriorities.getStatusById(info.getStatus()));
                    cell.setCellStyle(contentstyle);                    
