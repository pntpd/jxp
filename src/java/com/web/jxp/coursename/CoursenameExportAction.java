...
public class CoursenameExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = coursename.getListForExcel(search);
            int total = list.size();  
            String fileName = "Coursename_Report";
            ...
            {
                CoursenameInfo info = (CoursenameInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  coursename.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                     
                }
                info = null;
        }
