...
public class AccessExportAction extends Action
{
    ...
    { 
       try
        { 
            ...
            ArrayList list = access.getListForExcel(search);
            int total = list.size();  
            String fileName = "Access_Report";
            ...
            {
                AccessInfo info = (AccessInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell.setCellStyle(contentstyle);
                    cell = row.createCell(col++);         
                    cell.setCellValue(info.getIpaddress() != null ? info.getIpaddress() : "");
                    cell.setCellStyle(contentstyle);
                    cell = row.createCell(col++);         
                    cell.setCellValue(info.getDesc() != null ? info.getDesc() : "");
                    cell.setCellStyle(contentstyle);
                }
                info = null;
        }
