...
public class CrewtypeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = crewtype.getListForExcel(search);
            int total = list.size();  
            String fileName = "Crewtype_Report";
            ...
            {
                CrewtypeInfo info = (CrewtypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  crewtype.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                   
                }
                info = null;
            }
