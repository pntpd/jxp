...
public class TimesheetExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = timesheet.getExcel(allclient, permission, cids, assetids, clientIdIndex, assetIdIndex, type);
            int total = list.size();  
            String fileName = "Timesheet_Index_Report";
            ...
            for(int i = 0; i < total;i++)
            {
                ...
                {                    
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getTcount());
                    cell.setCellStyle(contentstyle);
                }
                info = null;
            }
