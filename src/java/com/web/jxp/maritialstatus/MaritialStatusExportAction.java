...
public class MaritialStatusExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = maritialstatus.getListForExcel(search);
            int total = list.size();  
            String fileName = "MaritialStatus_Report";
            ...
            {
                MaritialStatusInfo info = (MaritialStatusInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  maritialstatus.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                 
                }
                info = null;
            }
