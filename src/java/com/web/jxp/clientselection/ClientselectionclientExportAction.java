...
public class ClientselectionclientExportAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            ArrayList list = clientselection.getClientSelectListForExcel(search, statusIndex, clientIdIndex, assetIdIndex, pgvalue, allclient, permission, cids, assetids);
            int total = list.size();
