...
public class RevisionExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = revision.getListForExcel(search);
            int total = list.size();  
            String fileName = "Revision_Reason_Report";
            ...
            {
                RevisionInfo info = (RevisionInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  revision.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                     
                }
                info = null;
            }
