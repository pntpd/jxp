...
public class VaccineExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = vaccine.getListForExcel(search);
            int total = list.size();  
            String fileName = "Vaccine_Names_Report";
            ...
            {
                VaccineInfo info = (VaccineInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  vaccine.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                 
                }
                info = null;
            }
