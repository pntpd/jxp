...
public class EnginetypeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = enginetype.getListForExcel(search);
            int total = list.size();  
            String fileName = "Enginetype_Report";
            ...
            {
                EnginetypeInfo info = (EnginetypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  enginetype.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                   
                }
                info = null;
            }
