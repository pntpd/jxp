...
public class CrewinsuranceExportAction extends Action
{
       ...
       try
        {
            ...
            ArrayList list = crewinsurance.getListForExcel(search, positionIdIndex, clientIdIndex, assetIdIndex, allclient, 
                    permission, cids, assetids, statusIndex);
            int total = list.size();  
            String fileName = "Crewinsurance_Report";
            ...
            {
                CrewinsuranceInfo info = (CrewinsuranceInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
