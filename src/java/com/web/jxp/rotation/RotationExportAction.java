...
public class RotationExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = rotation.getListForExcel(search);
            int total = list.size();  
            String fileName = "Rotation_Report";
            ...
            {
                RotationInfo info = (RotationInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  rotation.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);
                }
                info = null;
            }
