...
public class MobilizationExportAction extends Action 
{
    @Override
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception 
    {
        try 
        {
            ...
            ArrayList list = mobilization.getListForExcel(search, statusIndex, clientIdIndex, assetIdIndex, countryId, allclient, permission, cids, assetids);
            int total = list.size();
            String fileName = "Mobilization_Report";
            ...
            cell = row.createCell(c);
            cell.setCellValue("Mobilization");
            sheet.setColumnWidth(c, 256 * 30);
            cell.setCellStyle(headstyle);
            c++;
