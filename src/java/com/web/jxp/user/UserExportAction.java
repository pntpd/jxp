...
public class UserExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = user.getListForExcel(search);
            int total = list.size();  
            ...
            for(int i = 0; i < total;i++)
            {
                ...
                {                    
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue( info.getContact1() != null ? info.getContact1() : "");
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getPermission()!= null ? info.getPermission(): "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  user.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);
                }
                info = null;
            }
