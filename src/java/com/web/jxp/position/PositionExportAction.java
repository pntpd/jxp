...
public class PositionExportAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        try 
        {
            ...
            ArrayList list = position.getListForExcel(search);
            int total = list.size();
            String fileName = "Position_Report";
            ...
            cell = row.createCell(c);
            cell.setCellValue("Minimum Qualification");
            sheet.setColumnWidth(c, 256 * 30);
            cell.setCellStyle(headstyle);
            c++;

            cell = row.createCell(c);
            cell.setCellValue("Crew Rotation");
            sheet.setColumnWidth(c, 256 * 30);
            cell.setCellStyle(headstyle);
            c++;
            ...
            for (int i = 0; i < total; i++) 
            {
                ...
                if (info != null) 
                {
                    ...
                    if(info.getPositiontitle() != null && !info.getPositiontitle().equals(""))
                        cell.setCellValue(info.getPositiontitle());
                    else
                        cell.setCellType(cell.CELL_TYPE_BLANK);
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    if(info.getGrade() != null && !info.getGrade().equals(""))
                    ...
                    cell = row.createCell(col++);
                    if(info.getAsset() != null && !info.getAsset().equals(""))
                        cell.setCellValue(info.getAsset());
                    else
                        cell.setCellType(cell.CELL_TYPE_BLANK);
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    if(info.getMinqualification() != null && !info.getMinqualification().equals(""))
                        cell.setCellValue(info.getMinqualification());
                    else
                        cell.setCellType(cell.CELL_TYPE_BLANK);
                    cell.setCellStyle(contentstyle);
                    ...
                    if(info.getRotation() != null && !info.getRotation().equals(""))
                        cell.setCellValue(info.getRotation());
                    else
                        cell.setCellType(cell.CELL_TYPE_BLANK);
                    cell.setCellStyle(contentstyle);
                }
