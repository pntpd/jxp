...
public class ApprovedbyExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = approvedby.getListForExcel(search);
            int total = list.size();  
            String fileName = "Approvedby_Report";
            ...
            {
                ApprovedbyInfo info = (ApprovedbyInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  approvedby.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                 
                }
                info = null;
        }
