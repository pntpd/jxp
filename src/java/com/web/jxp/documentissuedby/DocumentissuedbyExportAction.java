...
public class DocumentissuedbyExportAction extends Action
{
    ...
    { 
       try
        { 
            Documentissuedby documentissuedbyexportaction = new Documentissuedby();
            DocumentissuedbyForm frm = (DocumentissuedbyForm)form;
             
            String search =  frm.getSearch() != null ? frm.getSearch() : "";
            
            ArrayList list = documentissuedbyexportaction.getExcel(search);
            int total = list.size();  
            String fileName = "Documentissuedby_excel_report";
            ...
            cell = row.createCell(c);
            cell.setCellValue("Issue Authority");
            ...
            {
                DocumentissuedbyInfo info = (DocumentissuedbyInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getDocumentissuedbyName()!= null ? info.getDocumentissuedbyName(): "");
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(documentissuedbyexportaction.getStatusById(info.getStatus()));
                    cell.setCellStyle(contentstyle);
                }
                info = null;
        }
