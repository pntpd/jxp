...
public class AppealreasonExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = appealreason.getListForExcel(search);
            int total = list.size();  
            String fileName = " Competency_Result_Report";
            ...
            {
                AppealreasonInfo info = (AppealreasonInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  appealreason.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                
                }
                info = null;
        }
