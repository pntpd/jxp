...
public class CurrencyExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = currency.getListForExcel(search);
            int total = list.size();  
            String fileName = "Currency_Report";
            ...
            {
                CurrencyInfo info = (CurrencyInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  currency.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                 
                }
                info = null;
            }
