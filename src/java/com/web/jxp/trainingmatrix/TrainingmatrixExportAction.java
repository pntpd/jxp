...
public class TrainingmatrixExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = trainingmatrix.getExcel(search, allclient, permission, cids, assetids, clientIdIndex, assetIdIndex);
            int total = list.size();  
            String fileName = "Trainingmatrix_Report";
