...
public class FormalityExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = formality.getListForExcel(search, allclient, permission, cids, assetids);
            int total = list.size();  
            String fileName = "Onboarding_Formality_Report";
            ...
            {
                FormalityInfo info = (FormalityInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getCandidatename()!= null ? info.getCandidatename(): "");
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  formality.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                                          
                }
                info = null;
            }
