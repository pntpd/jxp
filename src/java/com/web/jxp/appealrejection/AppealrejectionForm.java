...
public class AppealrejectionForm extends ActionForm
{
    ...
    /**
     * @param appealrejectionId the appealrejectionId to set
     */
    public void setAppealrejectionId(int appealrejectionId) {
