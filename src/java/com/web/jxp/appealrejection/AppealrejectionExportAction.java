...
public class AppealrejectionExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = appealrejection.getListForExcel(search);
            int total = list.size();  
            String fileName = " Appeal_Rejection_Reason_Report";
            ...
            {
                AppealrejectionInfo info = (AppealrejectionInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  appealrejection.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);              
                }
                info = null;
        }
