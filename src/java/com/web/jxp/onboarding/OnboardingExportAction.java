...
public class OnboardingExportAction extends Action
{
    ...
    { 
       try
        { 
            ...
            ArrayList list = onboarding.getListForExcel(search, statusIndex, clientIdIndex, assetIdIndex, allclient,  permission,  cids,  assetids);
            int total = list.size();  
            String fileName = "Onboarding_Report";
            ...
            for(int i = 0; i < total;i++)
            {
                ...
                {                    
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getCountry()!= null ? info.getCountry(): "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getOnboardCount()+"/"+info.getTotalnoofopenings());
                    cell.setCellStyle(contentstyle);
                }
                info = null;
        }
