...
public class RemarkExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = remark.getListForExcel(search);
            int total = list.size();  
            String fileName = "Remarktype_Report";
            ...
            {
                RemarkInfo info = (RemarkInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  remark.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                                      
                }
                info = null;
            }
