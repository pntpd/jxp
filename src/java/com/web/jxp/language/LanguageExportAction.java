...
public class LanguageExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = language.getListForExcel(search);
            int total = list.size();  
            String fileName = "Language_Report";
            ...
            {
                LanguageInfo info = (LanguageInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  language.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                 
                }
                info = null;
            }
