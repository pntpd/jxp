...
public class GradeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = grade.getListForExcel(search);
            int total = list.size();  
            String fileName = "Grade_Report";
            ...
            {
                GradeInfo info = (GradeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  grade.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                 
                }
                info = null;
            }
