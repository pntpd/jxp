...
public class VaccinetypeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = vaccinetype.getListForExcel(search);
            int total = list.size();  
            String fileName = "Vaccinetype_Report";
            ...
            {
                VaccinetypeInfo info = (VaccinetypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  vaccinetype.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);            
                }
                info = null;
            }
