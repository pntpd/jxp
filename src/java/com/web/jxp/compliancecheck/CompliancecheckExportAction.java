...
public class CompliancecheckExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = compliancecheck.getJobpostListForExcel(search, clientIdIndex, assetIdIndex, pgvalue, allclient,  permission,  cids,  assetids);
            int total = list.size();  
            ...
            for(int i = 0; i < total;i++)
            {
                ...
                {                    
                    ...
                    cell.setCellValue((compliancecheck.changeNum( info.getJobpostId(),6) ));
