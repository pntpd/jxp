...
public class BankExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = bank.getListForExcel(search);
            int total = list.size();  
            String fileName = "Bank_Report";
            ...
            {
                BankInfo info = (BankInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getAccno ()!= null ? info.getAccno() : "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getIfsc() != null ? info.getIfsc() : "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  bank.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                     
                }
                info = null;
            }
