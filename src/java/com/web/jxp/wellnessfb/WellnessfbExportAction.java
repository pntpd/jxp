...
public class WellnessfbExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = wellnessfb.getListForExcel();
            int total = list.size();  
            String fileName = "Wellnessfb_Report";
            ...
            cell = row.createCell(c);
            cell.setCellValue("Send notification before (days)");
            sheet.setColumnWidth(c, 256*30);
            cell.setCellStyle(headstyle);
            c++;
            ...
            for(int i = 0; i < total;i++)
            {
                ...
                {                    
                    ...
                    cell = row.createCell(col++);
                    if(info.getCategoryname()!= null && !temp.equals(info.getCategoryname()))
                    {
                        cell.setCellValue(info.getCategoryname()!= null ? info.getCategoryname() : "");
                        temp = info.getCategoryname();
                    }                    
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getNotification()!= null ? info.getNotification() : "");
                    cell.setCellStyle(contentstyle);
