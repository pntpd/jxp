...
public class VerificationExportAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            ArrayList list = verification.getListForExcel(search, statusIndex, positionIndex, tabIndex);
            int total = list.size();
            String fileName = "Verification_Report";
            ...
            for (int i = 0; i < total; i++) 
            {
                ...
                if (info != null) 
                {
                    ...
                    cell.setCellValue(info.getIds() != null ? info.getIds() : "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getEnrollon() != null ? info.getEnrollon() : "");
                    cell.setCellStyle(contentstyle);
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getFlagstatus() != null ? info.getFlagstatus() : "");
                    cell.setCellStyle(contentstyle);
                }
                info = null;
            }
