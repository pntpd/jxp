...
public class AssettypeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = assettype.getListForExcel(search);
            int total = list.size();  
            String fileName = "Assettype_Report";
            ...
            {
                AssettypeInfo info = (AssettypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  assettype.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                                      
                }
                info = null;
            }
