...
public class LevelExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = level.getListForExcel(search);
            int total = list.size();  
            String fileName = "Level_Report";
            ...
            {
                LevelInfo info = (LevelInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  level.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                    
                }
                info = null;
            }
