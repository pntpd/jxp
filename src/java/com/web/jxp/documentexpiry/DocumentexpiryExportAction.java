...
public class DocumentexpiryExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            int dropdownId = frm.getDropdownId();
            int healthId = frm.getHealthId();
            ArrayList list = documentexpiry.getListForExcel(documentId, type, exp, clientIdIndex, assetIdIndex, 
                    allclient, permission, cids, assetids, coursenameId, dropdownId, healthId);
            int total = list.size();  
            ...
            for(int i = 0; i < total;i++)
            {
                ...
                {                    
                    ...
                    cell.setCellValue(documentexpiry.changeNum(info.getCandidateId(), 3));                    
