...
public class AssessmentAnswerTypeExportAction extends Action
{
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = assessmentAnswerType.getListForExcel(search);
            int total = list.size();  
            String fileName = "AssessmentAnswerType_Report";
            ...
            {
                AssessmentAnswerTypeInfo info = (AssessmentAnswerTypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell.setCellValue(assessmentAnswerType.changeNum(info.getAssessmentAnswerTypeId(), 3));
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  assessmentAnswerType.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);                  
                }
                info = null;
        }
