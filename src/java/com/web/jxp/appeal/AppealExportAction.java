...
public class AppealExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            ...
            ArrayList list = appeal.getListForExcel(search);
            int total = list.size();  
            String fileName = "Appeal_Reason_Report";
            ...
            {
                AppealInfo info = (AppealInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getStatus() != 0 ?  appeal.getStatusById(info.getStatus()) : "");
                    cell.setCellStyle(contentstyle);               
                }
                info = null;
            }
