...
public class BenefitinformationtypeExportAction extends Action
{        
    @Override
    ...
    { 
       try
        { 
            Benefitinformationtype benefitinformationtypeexportaction = new Benefitinformationtype();
            BenefitinformationtypeForm frm = (BenefitinformationtypeForm)form;
             
            String search =  frm.getSearch() != null ? frm.getSearch() : "";
            
            ArrayList list = benefitinformationtypeexportaction.getExcel(search);
            int total = list.size();  
            String fileName = "Benefitinformationtype_excel_report";
            ...
            {
                BenefitinformationtypeInfo info = (BenefitinformationtypeInfo) list.get(i);
                if(info != null)
                {                    
                    col = 0 ;
                    ...
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getBenefitinformationtypeName()!= null ? info.getBenefitinformationtypeName(): "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(info.getBenefittypeName()!= null ? info.getBenefittypeName(): "");
                    cell.setCellStyle(contentstyle);
                    
                    cell = row.createCell(col++);
                    cell.setCellValue(benefitinformationtypeexportaction.getStatusById(info.getStatus()));
                    cell.setCellStyle(contentstyle);
                }
                info = null;
        }
