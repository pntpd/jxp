...
<html:form action="/enginetype/EnginetypeAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${enginetypeForm.enginetypeId <= 0}">
                                        Add Engine Type
                                    </c:when>
                                    <c:otherwise>
                                        Edit Engine Type
