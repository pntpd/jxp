...
<body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
    <html:form action="/framework/FrameworkAction.do" onsubmit="return false;">
...
<%
                                            ...
                                            <div class="wesl_pagination pagination-mg m_15">
                                                <div class="wesl_pg_rcds">
                                                    Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=frameworkCount%>)                                                
                                                </div>
...
%>
                                                                    <tr class='hand_cursor'>
                                                                        ...
                                                                        <td class="hand_cursor assets_list text-center"><a href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getClientId()%>', '<%=info.getAssetId()%>');"><%= info.getPending() %></a></td>
                                                                        <td>
                                                                            <a href="javascript: showDetail('<%= info.getClientId()%>', '<%=info.getAssetId()%>');" class="edit_mode float-end mr_15"><% if(info.getCcount() > 0) {%><img src="../assets/images/pencil.png"/><% } else { %><img src="../assets/images/link.png"/><% } %></a>
                                                                        </td>
                                                                    </tr>
<%
                                                                }
