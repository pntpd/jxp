...
<html lang="en">
    ...
    <html:form action="/pcategory/PcategoryAction.do" onsubmit="return false;">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    <label for="example-text-input" class="col-sm-4 col-form-label">Asset Type:</label>
...
%>
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=pcategoryCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-right" width="14%"><span><b>Actions</b></span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="sort_id">
<%
...
%>
                                                                <tr>
                                                                    ...
                                                                    <td class="assets_list text-center"><a href="javascript: showDetail('<%= info.getPcategoryId()%>');"><%= pcategory.changeNum(info.getQcount(), 2)%></a></td>
                                                                    <td class="action_column">
                                                                        <a class="mr_15" href="javascript: showDetail('<%= info.getPcategoryId()%>');"><img src="../assets/images/plus.png"></a>
                                                                        <% if (editper.equals("Y") && info.getStatus() == 1) {%><a class="mr_15" href="javascript: modifyForm('<%= info.getPcategoryId()%>');"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                        <span class="switch_bth float-end">
                                                                            <div class="form-check form-switch">
                                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getPcategoryId()%>', '<%=status%>', '<%=i%>');"/>
                                                                            </div>
                                                                        </span>                                                                        
                                                                    </td>
                                                                </tr>
