...
<html lang="en">
    ...
    <%
        ...
        if (request.getAttribute("BENEFIT_LIST") != null) {
            jobpostbenefit_list = (ArrayList) request.getAttribute("BENEFIT_LIST");
        }
    ...
    <html:form action="/jobpost/JobPostAction.do" onsubmit="return false;" styleClass="form-horizontal">
        ...
        <html:hidden property="jobpostBenefitId"/>
        ...
        <html:hidden property="doDeleteJobPostBenefitDetail"/>
                                    ...
                                    <div class="row d-none1">
                                        <div class="col-lg-12">
                                            <div class="main-heading m_30">
                                                <div class="add-btn">
                                                    <h4>POSITION BENEFITS</h4>
                                                </div>
                                                <div class="edit_btn pull_right float-end">
                                                    <% if (editper.equals("Y") && jpinfo.getStatus() == 1) {%>
                                                                ...
                                                                <td class="action_column">
                                                                    <span class="switch_bth">
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" role="switch" <%=jpinfo.getStatus() == 2 || jpinfo.getStatus() == 3 ? "disabled" : ""%> id="flexSwitchCheckDefault_<%=info.getJobpostbenefitId()%>" <%if (info.getStatus() == 1) {%>checked<% }
                                                                                    if (!editper.equals("Y")) {%> disabled="true"<% }%> onclick="javascript: deleteJobPostBenefit('<%= info.getJobpostbenefitId()%>', '<%=info.getStatus()%>');" />
                                                                        </div>
                                                                    </span>
                                                                </td>
                                                            </tr>
