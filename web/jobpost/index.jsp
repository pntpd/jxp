...
<html lang="en">
    ...
    <html:form action="/jobpost/JobPostAction.do" onsubmit="return false;">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-9 field_ic">
                                                        <html:select styleClass="form-select" property="statusIndex" onchange="javascript: searchFormAjax('s', '-1');">
                                                            ...
                                                            <html:option value="3">Closed</html:option>
                                                        </html:select>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row" id='ajax_cat'>
                                        ...
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages%>, &nbsp;(<%= nextCount * recordsperpage + 1%> - <%= last > 0 ? last : nextCount * recordsperpage + recordsperpage%> record(s) of <%=jobpostCount%>)                                                
                                            </div>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="12%">
                                                                    ...
                                                                    <a href="javascript: sortForm('5', '2');" id="img_5_2" class="sort_arrow active_sort"><i class="ion ion-ios-arrow-up"></i></a>
                                                                    <a href="javascript: sortForm('5', '1');" id="img_5_1" class="sort_arrow deactive_sort"><i class="ion ion-ios-arrow-down"></i></a>
                                                                </th>
                                                                <th width="7%" class="text-center"><span><b>Openings</b></span></th>
                                                                <th width="14%" class="text-right"><span><b>Actions</b></span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="sort_id">
                                                            <%
                                                            ...
                                                            %>
                                                            <tr>
                                                                <td class="hand_cursor" href="javascript: void(0);" onclick="showDetail('<%= info.getJobpostId()%>');"><%= info.getRefno() != null ? info.getRefno() : ""%></td>
                                                                <td class="hand_cursor" href="javascript: void(0);" onclick="showDetail('<%= info.getJobpostId()%>');"><%= info.getPoston() != null ? info.getPoston() : ""%></td>
                                                                <td class="hand_cursor" href="javascript: void(0);" onclick="showDetail('<%= info.getJobpostId()%>');"><%= info.getClientname() != null ? info.getClientname() : ""%></td>
                                                                <td class="hand_cursor" href="javascript: void(0);" onclick="showDetail('<%= info.getJobpostId()%>');"><%= info.getPositionname() != null ? info.getPositionname() : ""%></td>
                                                                <td class="hand_cursor" href="javascript: void(0);" onclick="showDetail('<%= info.getJobpostId()%>');"><%= info.getGrade() != null ? info.getGrade() : ""%></td>
                                                                <td class="hand_cursor" href="javascript: void(0);" onclick="showDetail('<%= info.getJobpostId()%>');"><%= info.getTargetmobdate() != null ? info.getTargetmobdate() : ""%></td>
                                                                <td class="assets_list text-center hand_cursor" href="javascript: void(0);" onclick="showDetail('<%= info.getJobpostId()%>');"><a href="javascript:void(0);"><%= info.getOpening() != null && !info.getOpening().equals("") ? info.getOpening() : "&nbsp;"%></a></td>
                                                                <td class="action_column">
                                                                    <% if (status == 1) {%><a href="javascript: searchFormShortlist('<%= info.getJobpostId()%>');" class="mr_15"><img src="../assets/images/view_icon.png"></a><% }%>
                                                                    <% if (editper.equals("Y") && status == 1) {%><a href="javascript: modifyForm('<%= info.getJobpostId()%>');" class="mr_15"><img src="../assets/images/pencil.png"></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>
                                                                    <span class="switch_bth <% if(status == 3) {%>close_switch<% }%>">
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=i%>" <%if (status == 1 || status == 3) {%>checked <% }%> 
                                                                                   <%if (!editper.equals("Y") || status == 3) {%> disabled="true"<% }%> onclick="javascript: deleteForm('<%= info.getJobpostId()%>', '<%=status%>', '<%=i%>');" />
                                                                        </div>
                                                                    </span>
                                                                </td>																	
                                                            </tr>
