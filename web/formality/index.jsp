...
<html lang="en">
    ...
    <%
            ...
            int count = 0;
            int recordsperpage = formality.getCount();
            ...
            int showsizelist = formality.getCountList("show_size_list");
            int CurrPageNo = 1;
    ...
    <html:form action="/formality/FormalityAction.do" onsubmit="return false;">
                    ...
                    <div class="row head_title_area">
                        <div class="col-md-12 col-xl-12">
                            <div class="float-start back_arrow">
                                ...
                                <span>Onboarding Formality</span>
                            </div>
                                ...
                                <div class="body-background mt_0">
                                    <div class="row" id='ajax_cat'>
                                        ...
                                        <%
                                                                                                                            ...
                                                                                                                            if (recordsperpage > 0)
                                                                                                                            {
                                                                                                                                noOfPages = formalityCount / recordsperpage;
                                                                                                                                if (formalityCount % recordsperpage > 0)
                                                                                                                                    noOfPages += 1;
                                                                                                                            }
                                                                                                                            if(total > 0)
                                                                                                                            {
                                        ...
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=formalityCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        ...
                                                        <tbody id="sort_id">
                                                            ...
                                                            <tr class='hand_cursor' href='javascript: void(0);'>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getFormalityId()%>');"><%= info.getCandidatename() != null ? info.getCandidatename() : ""%></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getFormalityId()%>');"><%= info.getName() != null ? info.getName() : ""%></td>
                                                                <td>
                                                                    <span class="switch_bth float-end">
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getFormalityId()%>', '<%=status%>', '<%=i%>');"/>
                                                                        </div>
                                                                    </span>
                                                                    <% if (editper.equals("Y") && info.getStatus() == 1) {%><a href="javascript: modifyForm('<%= info.getFormalityId()%>');" class="edit_mode float-end mr_15"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                </td>
                                                            </tr>
                                                            <%
                                                                                                                        }
