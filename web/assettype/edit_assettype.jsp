...
<html:form action="/assettype/AssettypeAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${assettypeForm.assettypeId <= 0}">
                                        Add Asset Type
                                    </c:when>
                                    <c:otherwise>
                                        Edit Asset Type
