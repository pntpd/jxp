...
<html:form action="/matrix/MatrixAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${matrixForm.matrixId <= 0}">
                                        Configure Matrix
                                    </c:when>
                                    <c:otherwise>
                                        Configure Matrix
                                ...
                                <div class="row d-none1">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                            <label class="form_label">Training Code</label>
                                            <html:text property="mid" styleClass="form-control" readonly="true" />   
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                            <label class="form_label">Matrix Name</label>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 form_group" id="submitdiv">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a href="javascript: gobackassign();" class="cl_btn"><i class="ion ion-md-close"></i> Close</a>
                                            </c:otherwise>
                                        </c:choose>                                        
                                    </div>
                                </div>
