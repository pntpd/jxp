...
<html lang="en">
    ...
    <%
            ...
            int count = 0;
            int recordsperpage = trainingmatrix.getCount();
            ...
            int showsizelist = trainingmatrix.getCountList("show_size_list");
            int CurrPageNo = 1;
...
<body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
    <html:form action="/trainingmatrix/TrainingmatrixAction.do" onsubmit="return false;">
...
<%
                                                                                            ...
                                                                                            ((nextCount*recordsperpage) + recordsperpage))
                                                                                        {
                                                                                            prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                                                                                            prevclose = ("</i></a></li>");
                                                                                            last = trainingmatrixCount;
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            recordsperpage = trainingmatrixCount;
                                                                                        }
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                    ...
                                                                                    if (recordsperpage > 0)
                                                                                    {
                                                                                        noOfPages = trainingmatrixCount / recordsperpage;
                                                                                        if (trainingmatrixCount % recordsperpage > 0)
                                                                                            noOfPages += 1;
                                                                                    }
                                                                                    if(total > 0)
                                                                                    {
                                            ...
                                            <div class="wesl_pagination pagination-mg m_15">
                                                <div class="wesl_pg_rcds">
                                                    Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=trainingmatrixCount%>)                                                
                                                </div>
...
%>
                                                                    <tr class='hand_cursor'>
                                                                        <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getClientId()%>', '<%=info.getAssetId()%>');"><%= info.getClientName() != null ? info.getClientName() : ""%></td>
                                                                        <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getClientId()%>', '<%=info.getAssetId()%>');"><%= info.getClientAssetName() != null ? info.getClientAssetName() : ""%></td>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript: showDetail('<%= info.getClientId()%>', '<%=info.getAssetId()%>');" class="edit_mode float-end mr_15"><img src="../assets/images/pencil.png"/></a>
                                                                        </td>
                                                                    </tr>
<%
                                                                }
