...
<%
        ...
        if(session.getAttribute("CATEGORYWF_LIST") != null)
            wellnessfb_list = (ArrayList) session.getAttribute("CATEGORYWF_LIST");
        ...
        String thankyou = "no";
            ...
            {
                thankyou = (String)request.getAttribute("CATEGORYWFSAVEMODEL");
...
%>
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=wellnessfbCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th  class="text-center"><span><b>Sub-categories</b></span>
                                                                ...
                                                                <th  class="text-center"><span><b>Questions</b></span>
...
%>
                                                            <tr class="hand_cursor" href='javascript: void(0);'>
                                                                ...
                                                                <td class="assets_list text-center"><a href="javascript: viewSubcategory('<%= info.getCategoryId()%>');"><%=  wellnessfb.changeNum( info.getSubcategorycount(),2) %></a></td>
                                                                <td class="assets_list text-center"><a href="javascript: viewQuestioncat('<%= info.getCategoryId()%>');"><%=  wellnessfb.changeNum( info.getQuestioncount(),2) %></a></td>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h3>Feedback Category Created</h3>
