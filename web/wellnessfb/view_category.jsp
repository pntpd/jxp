...
<%
        ...
        String view_path = wellnessfb.getMainPath("view_trainingfiles");
        WellnessfbInfo info = null;
        if(request.getAttribute("CATEGORYWF_DETAIL") != null)
            info = (WellnessfbInfo)request.getAttribute("CATEGORYWF_DETAIL");
%>  
<head>
    <meta charset="utf-8">
...
<html:form action="/wellnessfb/WellnessfbAction.do" onsubmit="return false;" styleClass="form-horizontal">
            ...
            <div class="page-content tab_panel">
                <div class="row head_title_area">
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start"><a href="javascript: showcategory();" class="back_arrow"><img  src="../assets/images/back-arrow.png"/> View Wellness Feedback</a></div>
                        <div class="float-end">                            
                            ...
                            <div class="body-background">
                                <div class="row d-none1"><div class="main-heading">
                                        ...
                                        <div class="edit_btn pull_right float-end">
                                            <% if (editper.equals("Y") && info.getStatus() == 1) {%><a href="javascript: modifyForm('<%= info.getCategoryId()%>')"><img src="../assets/images/edit.png"></a><%}%>
                                        </div>
                                    </div>
                                    <div class="row">
<%
