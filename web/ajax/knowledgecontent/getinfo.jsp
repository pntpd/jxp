...
<%
    try 
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            sb.append("<thead>");
            sb.append("<tr>");
            sb.append("<th><span><b>Category Name</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th  class='text-center'><span><b>Module</b></span>");
            ...
            sb.append("</th>");
            sb.append("<th  class='text-center'><span><b>Topics</b></span>");
            ...
            if (request.getParameter("deleteVal") != null)
            {
                ...
                int result = knowledgecontent.deleteKnowledgecontent(id, uid, statusval, ipAddrStr, iplocal);
                ...
                ArrayList createtraining_list = knowledgecontent.getKnowledgecontentByName(search, n1, recordsperpage);
                int count = 0;
                if (createtraining_list.size() > 0) {
                    KnowledgecontentInfo cinfo = (KnowledgecontentInfo) createtraining_list.get(createtraining_list.size() - 1);
                ...
                if (total > 0)
                {
                    ...
                    str.append("<td>" + knowledgecontent.getMainPath("record_not_found") + "</td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
            ...
            } else if (request.getParameter("deleteVal") == null) 
            {
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    createtraining_list = knowledgecontent.getKnowledgecontentByName(search, n, recordsperpage);
                    if (createtraining_list.size() > 0) {
                        KnowledgecontentInfo cinfo = (KnowledgecontentInfo) createtraining_list.get(createtraining_list.size() - 1);
                        count = cinfo.getCategoryId();
                        createtraining_list.remove(createtraining_list.size() - 1);
