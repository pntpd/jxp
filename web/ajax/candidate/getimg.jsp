    ...
    try 
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            if (request.getParameter("candidateId") != null) 
            {
                ...
                String type = request.getParameter("type") != null && !request.getParameter("type").equals("") ? vobj.replaceint(request.getParameter("type")) : "0";
...
//                                String fn_download = fn + "-" + client.changeNum(candidateId, 6) + "-Resume" + (i + 1) + ext;
                                String fn_download = "Resume" + (i + 1) + ext;
                                if (i == 0) {
                                ...
                                if (info.getPassflag() == 2 || info.getPassflag() == 3) {
                                    ...
                                    if (deleteper.equals("Y") && size > 1 && !type.equals("1")) {
                    ...
                    sb.setLength(0);
                    response.getWriter().write(st1+"#@#"+client.changeNum(size, 2));
                } else {
