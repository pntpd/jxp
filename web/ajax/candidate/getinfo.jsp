...
<%
    try
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            sb.append("</th>");
            sb.append("<th width='12%'><span><b>Enrolled On</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='10%'><span><b>Country</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='10%'><span><b>City</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='19%'><span><b>Position Applied For</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='12%'><span><b>Enrollment</b> </span>");
            sb.append("<a href=\"javascript: sortForm('7', '2');\" id='img_7_2' class='sort_arrow deactive_sort'><i class='ion ion-ios-arrow-up'></i></a>");
            sb.append("<a href=\"javascript: sortForm('7', '1');\" id='img_7_1' class='sort_arrow deactive_sort'><i class='ion ion-ios-arrow-down'></i></a>");
            sb.append("</th>");
            sb.append("<th width='13%' class='text-right'><span><b>Actions</b> </span>");
            sb.append("</th>");
            sb.append("</tr>");
            sb.append("</thead>");
            ...
            String onlineflags = request.getParameter("onlineflag") != null && !request.getParameter("onlineflag").equals("") ? vobj.replaceint(request.getParameter("onlineflag")) : "0";
            String statustype_s = request.getParameter("statustype") != null && !request.getParameter("statustype").equals("") ? vobj.replaceint(request.getParameter("statustype")) : "0";
            ...
            int statustype = Integer.parseInt(statustype_s);
            int onlineflag = Integer.parseInt(onlineflags);
            ...
            if (request.getParameter("deleteVal") == null) 
            {
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    candidate_list = candidate.getCandidateByName(search, statusIndex, n, recordsperpage,onlineflag, statustype, assettypeIdIndex, positionIdIndex);
                ...
                if (total > 0) 
                {
                    ...
                    str.append("<tbody>");
                    str.append("<tr>");
                    str.append("<td><b>" + candidate.getMainPath("record_not_found") + "</b></td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
            ...
            } else if (request.getParameter("deleteVal") != null) 
            {
                ...
                statustype_s = request.getParameter("statustype") != null && !request.getParameter("statustype").equals("") ? vobj.replaceint(request.getParameter("statustype")) : "0";
                assettypeIdIndexs = request.getParameter("assettypeIdIndex") != null && !request.getParameter("assettypeIdIndex").equals("") ? vobj.replaceint(request.getParameter("assettypeIdIndex")) : "-1";
                positionIdIndexs = request.getParameter("positionIdIndex") != null && !request.getParameter("positionIdIndex").equals("") ? vobj.replaceint(request.getParameter("positionIdIndex")) : "-1";
            
                int id = Integer.parseInt(delete_ids);
                statustype = Integer.parseInt(statustype_s);
                int statusval = Integer.parseInt(status_s);
                assettypeIdIndex = Integer.parseInt(assettypeIdIndexs);
                positionIdIndex = Integer.parseInt(positionIdIndexs);
                int result = candidate.deleteCandidate(id, uid, statusval, ipAddrStr, iplocal);
                ...
                int recordsperpage = candidate.getCount();
                ArrayList candidate_list = candidate.getCandidateByName(search, -1, n1, recordsperpage,onlineflag, statustype, assettypeIdIndex, positionIdIndex);
                int count = 0;
                if (candidate_list.size() > 0) {
                    CandidateInfo cinfo = (CandidateInfo) candidate_list.get(candidate_list.size() - 1);
                    count = cinfo.getCandidateId();
                ...
                str.append("<input type='hidden' name='nextDel' value='" + total + "'/>");
                if (n1 == 0 && candidateCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n1 > 0 && candidateCount > ((n1 * recordsperpage) + recordsperpage)) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='Next'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                    prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                    prevclose = ("</i></a></li>");
