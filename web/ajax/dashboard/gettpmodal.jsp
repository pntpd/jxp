    ...
    try 
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            if (request.getParameter("crewrotationId") != null)
            {
                ...
                DashboardInfo info = dashboard.getTemporaryPromotionBydate(date, crewrotationId);
                ...
                if (!date.equals("0000:00:00"))
                {
                    ...
                    sb.append("<span class='form-control'>"+info.getSubtypevalue()+" - "+info.getPosition()+"</span>");
                    sb.append("</div>");
                    sb.append("<div class='col-lg-12 col-md-12 col-sm-12 col-4 form_group'>");
