...
<%
    try 
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            int showsizelist = client.getCountList("show_size_list");
            
            StringBuilder sb = new StringBuilder();
            
            sb.append("<thead>");
            sb.append("<tr>");
            sb.append("<th><span><b>ID</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th><span><b>Client</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th><span><b>Person In-charge</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th><span><b>Email</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th><span><b>Contact</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th><span><b>Assets</b> </span></th>");
            ...
            String countryIndexIds = request.getParameter("countryIndexId") != null && !request.getParameter("countryIndexId").equals("") ? vobj.replaceint(request.getParameter("countryIndexId")) : "-1";
            String assettypeIndexIds = request.getParameter("assettypeIndexId") != null && !request.getParameter("assettypeIndexId").equals("") ? vobj.replaceint(request.getParameter("assettypeIndexId")) : "-1";
            int n = Integer.parseInt(nextValue);
            int countryIndexId = Integer.parseInt(countryIndexIds);
            int assettypeIndexId = Integer.parseInt(assettypeIndexIds);
            ...
            if (request.getParameter("deleteVal") != null) 
            {
                ...
                int result = client.deleteClient(id, uid, statusval, ipAddrStr, iplocal);
                ...
                int recordsperpage = client.getCount();
                ArrayList client_list = client.getClientByName(search, n1, recordsperpage, countryIndexId,assettypeIndexId, allclient,  per,  cids,  assetids);
                int count = 0;
                if (client_list.size() > 0) {
                    ClientInfo cinfo = (ClientInfo) client_list.get(client_list.size() - 1);
                    count = cinfo.getClientId();
                    client_list.remove(client_list.size() - 1);
                }
                ...
                int noOfPages = 1;
                if (recordsperpage > 0) {
                    noOfPages = clientCount / recordsperpage;
                    if (clientCount % recordsperpage > 0) {
                        noOfPages += 1;
                    }
                }
                if (total > 0) 
                {
                    ...
                    str.append("(" + value + " - " + value1 + " record(s) of " + clientCount + ")&nbsp;");
                    str.append("</div>");
                    ...
                    {
                        info = (ClientInfo) client_list.get(i);
                        if (info != null) 
                        {
                            status = info.getStatus();
                            str.append("<tr class='hand_cursor' href='javascript: void(0);'>");
                            str.append("<td class='hand_cursor' href='javascript: void(0);' onclick='showDetail(" + info.getClientId() + ");'>" + (client.changeNum(info.getClientId(), 3)) + "</td>");
                            str.append("<td class='hand_cursor' href='javascript: void(0);' onclick='showDetail(" + info.getClientId() + ");'>" + (info.getName() != null ? info.getName() : "") + "</td>");
                            str.append("<td class='hand_cursor' href='javascript: void(0);' onclick='showDetail(" + info.getClientId() + ");'>" + (info.getInchargename() != null ? info.getInchargename() : "") + "</td>");
                            str.append("<td class='hand_cursor' href='javascript: void(0);' onclick='showDetail(" + info.getClientId() + ");'>" + (info.getEmail() != null ? info.getEmail() : "") + "</td>");
                            str.append("<td class='hand_cursor' href='javascript: void(0);' onclick='showDetail(" + info.getClientId() + ");'>" + (info.getContact() != null ? info.getContact() : "") + "</td>");
                            str.append("<td class='assets_list'><a href=\"javascript: viewasset('" + info.getClientId() + "');\">" + (client.changeNum(info.getAssetcount(),2)) + "</a></td>");
                            str.append("<td>");
                            ...
                            str.append(" onclick=\"javascript: deleteForm('" + info.getClientId() + "', '" + status + "', '" + (i) + "');\" />");
                            str.append("</div>");
                            str.append("</span>");
                            
                            if (editper.equals("Y") && info.getStatus() == 1) {
                                str.append("<a href=\"javascript: modifyForm('" + info.getClientId() + "');\" class='edit_mode float-end mr_15'><img src='../assets/images/pencil.png'/></a>");
                            }
                            str.append("</td>");
                            str.append("</tr>");
                        }
                    ...
                    str.append("<td>" + client.getMainPath("record_not_found") + "</td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
            ...
            else if (request.getParameter("deleteVal") == null)
            {
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    client_list = client.getClientByName(search, n, recordsperpage, countryIndexId,assettypeIndexId,allclient,  per,  cids,  assetids);
                    if (client_list.size() > 0) {
                        ClientInfo cinfo = (ClientInfo) client_list.get(client_list.size() - 1);
                        count = cinfo.getClientId();
                        client_list.remove(client_list.size() - 1);
                ...
                if (n == 0 && clientCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n > 0 && clientCount > ((n * recordsperpage) + recordsperpage)) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='Next'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                    prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                    prevclose = ("</i></a></li>");
