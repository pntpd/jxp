    ...
    try 
    {
        ...
        {           
            if (request.getParameter("col") != null) 
            {
                ...
                if (total > 0) 
                {
                    managetraining_list = managewellness.getFinalRecord(managetraining_list, colid, updown);
                    session.setAttribute("MANAGEWELLNESS_LIST", managetraining_list);
                    ...
                    for (int i = 0; i < total; i++)
                    {
                        ...
                        if (info != null) 
                        {
                            ...
                            str.append("<a href='javascript:;' class='off_total_value'>"+managewellness.changeNum(info.getTotal(),2)+"</a></a>");
                            str.append("</td>");
                            ...
                            str.append("<a href=\"javascript:viewtraing();\">View Feedback</a>");
