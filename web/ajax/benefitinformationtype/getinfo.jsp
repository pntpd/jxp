...
<%
    try
    {
        if (session.getAttribute("LOGININFO") != null)
        {
            ...
            sb.append("<thead>");
            sb.append("<tr>");
            sb.append("<th><span><b>Benefit Type</b> </span>");
            ...
            if (request.getParameter("deleteVal") != null)
            {
                ...
                int result = benefitinformationtype.deleteBenefitinformationtype(id, uid, statusval, ipAddrStr, iplocal);
                ...
                ArrayList benefitinformationtype_list = benefitinformationtype.getBenefitinformationtypeByName(search, n1, recordsperpage);
                int count = 0;
                if (benefitinformationtype_list.size() > 0) {
                    BenefitinformationtypeInfo cinfo = (BenefitinformationtypeInfo) benefitinformationtype_list.get(benefitinformationtype_list.size() - 1);
                    count = cinfo.getBenefitinformationtypeId();
                    benefitinformationtype_list.remove(benefitinformationtype_list.size() - 1);
                }
                ...
                if (n1 == 0 && benefitinformationtypeCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n1 > 0 && benefitinformationtypeCount > ((n1 * recordsperpage) + recordsperpage)) {
                ...
                if (total > 0) {
                    ...
                    str.append("(" + value + " - " + value1 + " record(s) of " + benefitinformationtypeCount + ")&nbsp;");
                    str.append("</div>");
                    ...
                    str.append("<td>" + benefitinformationtype.getMainPath("record_not_found") + "</td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
            ...
            else if (request.getParameter("deleteVal") == null) 
            {
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    benefitinformationtype_list = benefitinformationtype.getBenefitinformationtypeByName(search, n, recordsperpage);
                    if (benefitinformationtype_list.size() > 0) {
                        BenefitinformationtypeInfo cinfo = (BenefitinformationtypeInfo) benefitinformationtype_list.get(benefitinformationtype_list.size() - 1);
                        count = cinfo.getBenefitinformationtypeId();
                        benefitinformationtype_list.remove(benefitinformationtype_list.size() - 1);
                ...
                if (n == 0 && benefitinformationtypeCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n > 0 && benefitinformationtypeCount > ((n * recordsperpage) + recordsperpage)) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='Next'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                    prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                    prevclose = ("</i></a></li>");
