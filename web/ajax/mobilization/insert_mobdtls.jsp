            ...
            if (request.getParameter("crewroationid") != null)
            {
                ...
                if (crewroationId > 0) 
                {
                    ...
                    if (attachfile.equals("")) {
                        ...
                        String foldername = mobilization.createFolder(add_mobilization);
                        Date now = new Date();
                        String fn = String.valueOf(now.getTime());
                        filename = mobilization.saveImage(attachfile, add_mobilization, foldername, fn);
                    }
                    int batch = mobilization.insertMobilizationDtls(crewroationId, type, val1, val2, val3, val4, val5, val6, val7, val8, vald9, valt9, vald10, valt10, filename, uid, 1);
