...
<%
    try 
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            String permission = "", cids = "", assetids = "";
            if (uinfo != null)
            {
                cids = uinfo.getCids();
                permission = uinfo.getPermission() != null ? uinfo.getPermission() : "N";
                allclient = uinfo.getAllclient();
                assetids = uinfo.getAssetids();
            }
            int showsizelist = mobilization.getCountList("show_size_list");
            StringBuilder sb = new StringBuilder();
            sb.append("<thead>");
            sb.append("<tr>");

            sb.append("<th rowspan='2' width='33%'>");
            ...
            sb.append("<th rowspan='2' width='15%'>");
            sb.append("<span><b>Location</b></span>");
            ...
            sb.append("<th rowspan='2' width='9%' class='text-center'><span><b>Ongoing</b></span></th>");
            sb.append("<th rowspan='2' width='9%' class='text-center'><span><b>Action</b></span></th>");
            sb.append("</tr>");
            sb.append("</thead>");
            ...
            if (request.getParameter("deleteVal") == null) 
            {
                ...
                int recordsperpage = mobilization.getCount();
                ArrayList candidate_list = new ArrayList();
                int count = 0;
                if (next1.equals("p") || next1.equals("n")) {
                    candidate_list = mobilization.getClientSelectByName(search, statusIndex, n, recordsperpage, clientIdIndex, assetIdIndex, countryId, allclient, permission, cids, assetids);
                    if (candidate_list.size() > 0) {
                        MobilizationInfo cinfo = (MobilizationInfo) candidate_list.get(candidate_list.size() - 1);
                ...
                if (total > 0) 
                {
                    ...
                    str.append("<tbody>");
                    str.append("<tr>");
                    str.append("<td><b>" + mobilization.getMainPath("record_not_found") + "</b></td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
