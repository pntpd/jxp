...
<%
    try 
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            sb.append("<thead>");
            sb.append("<tr>");
            sb.append("<th width='18%'><span><b>Competency Priority</b> </span>");
            ...
            sb.append("</th>");            
            sb.append("<th width='15%'><span><b>Degree</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='15%'><span><b>Asset</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='24%'><span><b>Department</b> </span>");
            ...
            if (request.getParameter("deleteVal") != null) 
            {
                ...
                String assetIdIndex_s = request.getParameter("assetIdIndex") != null && !request.getParameter("assetIdIndex").equals("") ? vobj.replaceint(request.getParameter("assetIdIndex")) : "0";
                String clientIdIndexs = request.getParameter("clientIdIndex") != null && !request.getParameter("clientIdIndex").equals("") ? vobj.replaceint(request.getParameter("clientIdIndex")) : "0";
                String departmentIdIndexs = request.getParameter("departmentIdIndex") != null && !request.getParameter("departmentIdIndex").equals("") ? vobj.replaceint(request.getParameter("departmentIdIndex")) : "0";
                ...
                int departmentIdIndex = Integer.parseInt(departmentIdIndexs);
                int result = competencypriorities.deleteCompetencypriorities(id, uid, statusval, ipAddrStr, iplocal);
                ...
                ArrayList competencypriorities_list = competencypriorities.getCompetencyprioritiesByName(search, departmentIdIndex, clientIdIndex, assetIdIndex, n1, recordsperpage);
                int count = 0;
                if (competencypriorities_list.size() > 0) {
                    CompetencyprioritiesInfo cinfo = (CompetencyprioritiesInfo) competencypriorities_list.get(competencypriorities_list.size() - 1);
                    count = cinfo.getCompetencyprioritiesId();
                    competencypriorities_list.remove(competencypriorities_list.size() - 1);
                }
                ...
                if (n1 == 0 && competencyprioritiesCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n1 > 0 && competencyprioritiesCount > ((n1 * recordsperpage) + recordsperpage)) {
                ...
                if (total > 0)
                {
                    ...
                    str.append("(" + value + " - " + value1 + " record(s) of " + competencyprioritiesCount + ")&nbsp;");
                    str.append("</div>");
                    ...
                    str.append("<td>" + competencypriorities.getMainPath("record_not_found") + "</td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
            ...
            else if (request.getParameter("deleteVal") == null) 
            {
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    competencypriorities_list = competencypriorities.getCompetencyprioritiesByName(search, departmentIdIndex, clientIdIndex, assetIdIndex, n, recordsperpage); 
                    if (competencypriorities_list.size() > 0) {
                        CompetencyprioritiesInfo cinfo = (CompetencyprioritiesInfo) competencypriorities_list.get(competencypriorities_list.size() - 1);
                        count = cinfo.getCompetencyprioritiesId();
                        competencypriorities_list.remove(competencypriorities_list.size() - 1);
                ...
                if (n == 0 && competencyprioritiesCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n > 0 && competencyprioritiesCount > ((n * recordsperpage) + recordsperpage)) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='Next'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                    prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                    prevclose = ("</i></a></li>");
