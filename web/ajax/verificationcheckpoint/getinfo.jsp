...
<%
    try 
    {
        if (session.getAttribute("LOGININFO") != null)
        {
            ...
            sb.append("<thead>");
            sb.append("<tr>");
            sb.append("<th width='16%'><span><b>Checkpoint Name</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='10%'><span><b>Tab</b></span>");
            ...
            sb.append("</th>");
            sb.append("<th width='50%'><span><b>Display Note</b></span>");
            ...
            sb.append("</th>");
            sb.append("<th width='14%' class='text-center'><span><b>Minimum Requirement</b></span></th>");
            sb.append("<th width'10%' class='text-right'><span><b>Actions</b></span></th>");
            sb.append("</tr>");
            sb.append("</thead>");
            ...
            if (request.getParameter("deleteVal") != null) 
            {
                ...
                int result = verificationcheckpoint.deleteVerificationcheckpoint(id, uid, statusval, ipAddrStr, iplocal);
                ...
                ArrayList verificationcheckpoint_list = verificationcheckpoint.getVerificationcheckpointByName(search, -1, n1, recordsperpage);
                int count = 0;
                if (verificationcheckpoint_list.size() > 0) {
                    VerificationcheckpointInfo cinfo = (VerificationcheckpointInfo) verificationcheckpoint_list.get(verificationcheckpoint_list.size() - 1);
                    count = cinfo.getVerificationcheckpointId();
                    verificationcheckpoint_list.remove(verificationcheckpoint_list.size() - 1);
                }
                ...
                if (n1 == 0 && verificationcheckpointCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n1 > 0 && verificationcheckpointCount > ((n1 * recordsperpage) + recordsperpage)) {
                ...
                if (total > 0) 
                {
                    ...
                    str.append("(" + value + " - " + value1 + " record(s) of " + verificationcheckpointCount + ")&nbsp;");
                    str.append("</div>");
                    ...
                    str.append("<td>" + verificationcheckpoint.getMainPath("record_not_found") + "</td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    verificationcheckpoint_list = verificationcheckpoint.getVerificationcheckpointByName(search, -1, n, recordsperpage);
                    if (verificationcheckpoint_list.size() > 0) {
                        VerificationcheckpointInfo cinfo = (VerificationcheckpointInfo) verificationcheckpoint_list.get(verificationcheckpoint_list.size() - 1);
                        count = cinfo.getVerificationcheckpointId();
                        verificationcheckpoint_list.remove(verificationcheckpoint_list.size() - 1);
                ...
                if (n == 0 && verificationcheckpointCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n > 0 && verificationcheckpointCount > ((n * recordsperpage) + recordsperpage)) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='Next'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                    prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                    prevclose = ("</i></a></li>");
