...
<%
    try
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            sb.append("<thead>");
            sb.append("<tr>");
            sb.append("<th width='10%'><span><b>Client - Asset</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='11%'><span><b>Country</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th width='20%' class='text-center'><span><b>On-boarded</b> </span>");
            sb.append("</th>");
            
            sb.append("<th width='7%' class='text-center'><span><b>Action</b> </span>");
            sb.append("</th>");
            sb.append("</tr>");
            sb.append("</thead>");
            ...
            if (request.getParameter("deleteVal") == null) 
            {
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    candidate_list = onboarding.getClientSelectByName(search, statusIndex, n, recordsperpage, clientIdIndex, assetIdIndex,allclient,  per,  cids,  assetids);
                    if (candidate_list.size() > 0) {
                        OnboardingInfo cinfo = (OnboardingInfo) candidate_list.get(candidate_list.size() - 1);
                ...
                if (total > 0) 
                {
                    ...
                    str.append("<tbody>");
                    str.append("<tr>");
                    str.append("<td><b>" + onboarding.getMainPath("record_not_found") + "</b></td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
