    ...
    try
    {
        ...
        if (uInfo != null)
        {
            ...
            if (userId > 0) 
            {
                ...
                String uploadeddoc = onboarding.getFormalityuploadFormfile(onboarddocId);
                ...
                int deletestatus = onboarding.uploadformalitypdf( shortlistId,"",onboarddocId,userId);
                onboarding.updateonboardflagformail(shortlistId, userId, "", 6, 0, "");
