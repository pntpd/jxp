...
<%
    try 
    {
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            String iplocal = competencyassessments.getLocalIp();
            int showsizelist = competencyassessments.getCountList("show_size_list");
            StringBuilder sb = new StringBuilder();
            
            sb.append("<thead>");
            sb.append("<tr>");
            sb.append("<th><span><b>Title</b> </span>");
            ...
            sb.append("</th>");            
            sb.append("<th><span><b>Asset Type</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th><span><b>Department</b> </span>");
            ...
            sb.append("</th>");
            sb.append("<th class='text-center'><span><b>Schedule Needed</b> </span>");
            ...
            if (request.getParameter("deleteVal") != null) 
            {
                ...
                int result = competencyassessments.deleteCompetencyassessments(id, uid, statusval, ipAddrStr, iplocal);
                ...
                ArrayList competencyassessments_list = competencyassessments.getCompetencyassessmentsByName(search, departmentIdIndex, assettypeIdIndex, n1, recordsperpage);
                int count = 0;
                if (competencyassessments_list.size() > 0) {
                    CompetencyassessmentsInfo cinfo = (CompetencyassessmentsInfo) competencyassessments_list.get(competencyassessments_list.size() - 1);
                    count = cinfo.getCompetencyassessmentsId();
                    competencyassessments_list.remove(competencyassessments_list.size() - 1);
                }
                ...
                if (n1 == 0 && competencyassessmentsCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n1 > 0 && competencyassessmentsCount > ((n1 * recordsperpage) + recordsperpage)) {
                ...
                if (total > 0) 
                {
                    ...
                    str.append("(" + value + " - " + value1 + " record(s) of " + competencyassessmentsCount + ")&nbsp;");
                    str.append("</div>");
                    ...
                    str.append("<td>" + competencyassessments.getMainPath("record_not_found") + "</td>");
                    str.append("</tr>");
                    str.append("</tbody>");
                    str.append("</table>");
                    str.append("</div>");
            ...
            else if (request.getParameter("deleteVal") == null) 
            {
                ...
                if (next1.equals("p") || next1.equals("n")) {
                    competencyassessments_list = competencyassessments.getCompetencyassessmentsByName(search, departmentIdIndex, assettypeIdIndex, n, recordsperpage); 
                    if (competencyassessments_list.size() > 0) {
                        CompetencyassessmentsInfo cinfo = (CompetencyassessmentsInfo) competencyassessments_list.get(competencyassessments_list.size() - 1);
                        count = cinfo.getCompetencyassessmentsId();
                        competencyassessments_list.remove(competencyassessments_list.size() - 1);
                ...
                if (n == 0 && competencyassessmentsCount > recordsperpage) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                } else if (n > 0 && competencyassessmentsCount > ((n * recordsperpage) + recordsperpage)) {
                    next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='Next'><i class='fa fa-angle-right'>");
                    nextclose = ("</i></a></li>");
                    prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                    prevclose = ("</i></a></li>");
