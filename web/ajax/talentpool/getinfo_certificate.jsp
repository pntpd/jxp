        ...
        if (session.getAttribute("LOGININFO") != null) 
        {
            ...
            int dodirect = Integer.parseInt(dodirects);            
             if (true) 
             {
                ...
                {
                    talentpool_list = talentpool.gettrainingCertificatelist(candidateId, n, recordsperpage, courseIndex);
                ...
                session.setAttribute("CANDTRAININGCERTLIST", talentpool_list);
                    ...
                    for (int i = 0; i < total; i++) 
                    {
                        ...
                        if (info != null) 
                        {
                            ...
                            if(!filep.equals("")) {
                              ...
                              if (editper.equals("Y") && info.getStatus() == 1 && dstatus != 4)
                              {
