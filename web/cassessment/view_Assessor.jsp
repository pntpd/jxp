                ...
                <div class="page-content tab_panel1 no_tab1">
                    <div class="row head_title_area">
                        <div class="col-md-12 col-xl-12">
                            <div class="float-start back_arrow"><a href="javascript: gobackassessor();"><img  src="../assets/images/back-arrow.png"/></a> 
                                ...
                                <div class="body-background cre_assement">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-3 left_area">
                                            <div class="row">
                                                <div class="sort_status empty_filter" id="dassessmentsassessor">
                                                    <%
                                                    if(list_size > 0)
                                                        {
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li id="leftli<%=i+1%>">
                                                            <a href="javascript:void(0);">
                                                                <div class="col-lg-12 status_div scheduled_div">
                                        ...
                                        <div class="col-lg-8 col-md-9 right_area">
                                            <div class="row asses_candidate">
                                                ...
                                                <div class="col-lg-2 candi_prof_div">
                                                    <a href="javascript: viewCandidate('<%= info.getCandidateId()%>');">
                                            ...
                                            <div class="full_width" id="ajax_assessor_div">
