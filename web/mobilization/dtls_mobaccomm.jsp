...
<html lang="en">
    ...
    <%
        ...
        String mobfile_path = mobilization.getMainPath("view_mobilization");
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelAccom();"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="row">
                                                    ...
                                                    <div class="table-rep-plugin sort_table">
                                                        <div class="table-responsive mb-0">
                                                            <table id="tech-companies-1" class="table table-striped table-bordered">
                                                                <thead>
                                                                    <tr class="blue_bg">
                                                                        <th width="%" colspan="5" class="text-center"><span><b>HOTEL</b> </span></th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th width="3%" colspan="" class="text-center"><span><b>&nbsp;</b></span></th>
                                                                        <th width="3%" class="text-center"><span><b>&nbsp;</b></span></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <%
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="action_column text-center">
                                                                            <%
                                                                                if (editper.equals("Y")) {
                                                                            %>
                                                                            <a class="" onclick="getEditAccommdetails('<%=minfo.getMobilizationId()%>');" href="javascript:;"><img src="../assets/images/pencil.png"></a>
                                                                                <%
                                                                                    }else{%>&nbsp;<%}%>
                                                                        </td>
                                                                        <td class="action_column text-center">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    if (editper.equals("Y")) {
                                                    %>
                                                    <a href="javascript:void(0);" onclick="getHistoryMailDetails('<%=info.getCrewrotationId()%>', '2');" class="email_btn"><img src="../assets/images/email.png"/></a>
                                                        <%}%>
                                                </div>
                                            </div>	
                                        </div>
