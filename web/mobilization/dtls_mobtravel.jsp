...
<html lang="en">
    ...
    <%
        ...
        if (session.getAttribute("CANDIDATEINFO") != null) {
            info = (MobilizationInfo) session.getAttribute("CANDIDATEINFO");
        }
    ...
    <html:form action="/mobilization/MobilizationAction.do" onsubmit="return false;" enctype="multipart/form-data">
        ...
        <html:hidden property="doSaveMob"/>
        <html:hidden property="doMobhistMail"/>
        <html:hidden property="search"/>
        <html:hidden property="txtsearch"/>
        ...
        <html:hidden property="mobilizationId"/>
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelTravel();"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="col-md-5 com_label_value">
                                                    ...
                                                    <div class="row mb_0">
                                                        ...
                                                        <div class="col-md-9"><span><%=info.getPosition()%> <%if (!info.getPosition().equals("") && !info.getGrade().equals("")) {%>-<%}%> <%=info.getGrade()%></span></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 com_label_value">
                                                    <div class="row mb_0">
                                                        <div class="col-md-3"><label>Client - Asset</label></div>
                                                        <div class="col-md-9"><span><%=info.getClientName()%> <%if (!info.getClientName().equals("") && !info.getClientAsset().equals("")) {%>-<%}%> <%=info.getClientAsset()%></span></div>
                                                    </div>
                                                    <div class="row mb_0">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="row">
                                                <div class="col-md-12 col-xl-12 tab_head_area">
                                                    <%@include file ="../mobilizationtab.jsp"%>
                                                </div>
                                                    ...
                                                    <div class="table-rep-plugin sort_table">
                                                        <div class="table-responsive mb-0">
                                                            <table id="tech-companies-1" class="table table-striped table-bordered">
                                                                <thead>
                                                                    <tr class="blue_bg">
                                                                        <th width="%" class="text-center" colspan="2"><span><b>MODE</b> </span></th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th width="7%" class="text-center"><span><b>Flight/train /Bus/Car No.</b> </span></th>
                                                                        <th width="12%" class="text-center"><span><b>Location</b></span></th>
                                                                        ...
                                                                        <th width="9%" class="text-center"><span><b>ETD</b></span></th>
                                                                        <th width="12%" class="text-center"><span><b>Location</b></span></th>
                                                                        <th width="9%" class="text-center"><span><b>Airport/Train/Bus</b></span></th>
                                                                        <th width="7%" class="text-center"><span><b>Terminal/Platform No.</b></span></th>
                                                                        <th width="9%" class="text-center"><span><b>ETA</b></span></th>
                                                                        <th width="4%" class="text-center"><span><b>Edit</b></span></th>
                                                                        <th width="4%" class="text-center"><span><b>View</b></span></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <%
                                                                        if (total > 0) {
                                                                            ...
                                                                            for (int i = 0; i < total; i++) {
                                                                                minfo = (MobilizationInfo) mob_list.get(i);
                                                                                if (minfo != null) {
                                                                    %>
                                                                    <tr>
                                                                        <td class="text-center">
                                                                            <%if (!minfo.getFilename().equals("") && editper.equals("Y")) {%>
                                                                            <div class="mt-checkbox-inline check_box">
                                                                                <label class="mt-checkbox mt-checkbox-outline">
                                                                                    <input type="checkbox" id="chkmobId_<%=i%>" name="chkmobId_<%=i%>" value="<%=minfo.getMobilizationId()%>">
                                                                                    <span></span>
                                                                                </label>
                                                                            </div>
                                                                            <%}else{%>&nbsp;<%}%>
                                                                        ...
                                                                        <td><%=minfo.getVald9()%> | <%=minfo.getValt9()%></td>
                                                                        <td><%=minfo.getVal6()%></td>
                                                                        <td class="text-center"><%=minfo.getVal7()%></td>
                                                                        <td class="text-center"><%=minfo.getVal8()%></td>
                                                                        <td><%=minfo.getVald10()%> | <%=minfo.getValt10()%></td>
                                                                        <td class="action_column text-center">
                                                                            <%
                                                                                if (editper.equals("Y")) {
                                                                            %>
                                                                            <a class="" onclick="getEditTraveldetails('<%=minfo.getMobilizationId()%>');" href="javascript:;"><img src="../assets/images/pencil.png"></a>
                                                                                <%
                                                                                    }else{%>&nbsp;<%}%>
                                                                        </td>
                                                                        <td class="action_column text-center">
                                                                            <%if (!minfo.getFilename().equals("")) {%>
                                                                            <a data-bs-toggle="modal" data-bs-target="#view_pdf" onclick="javascript:setIframe('<%=view_mobilization + minfo.getFilename()%>');" href="javascript:;"><img src="../assets/images/view.png"></a>
                                                                            <%}else{%>&nbsp;<%}%>
                                                                        </td>
                                                                    </tr>
                                                                    <%
                                                                    ...
                                                                    <%}
                                                                    %>
                                                                <input type="hidden" id="mobFileMailCount" name="mobFileMailCount" value="<%=total%>" />
                                                                </tbody>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <a href="javascript:void(0);" onclick="viewcancel();" class="save_btn go_mobi">Go to Mobilization</a>
                                                    <%
                                                   if (editper.equals("Y")) {
                                                    %>
                                                    <a href="javascript:void(0);" class="email_btn" onclick="getHistoryMailDetails('<%=info.getCrewrotationId()%>', '1');"><img src="../assets/images/email.png"/></a>
                                                    <%}%>
                                                </div>
                                            </div>	
                                        </div>
        ...
        <div id="email_candidate_modal" class="modal fade parameter_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12" id="dhistorymaildetails">
