...
<html lang="en">
    ...
    <html:form action="/mobilization/MobilizationAction.do" onsubmit="return false;">
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th rowspan="2" width="9%" class="text-center"><span><b>Ongoing</b></span></th>
                                                                <th rowspan="2" width="9%" class="text-center"><span><b>Action</b></span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="sort_id">
                                                            <%
                                                            ...
                                                            <tr  href='javascript: void(0);'  >
                                                                ...
                                                                <td class="assets_list text-center"><a href="javascript:;" class="total_value"><%= info.getStatus1()%></a></td>
                                                                                ...
                                                                                <div class="dropdown_menu">
                                                                                    <div class="dropdown-wrapper">
                                                                                        <div class="category-menu">
                                                                                            <!--<a href="javascript: ViewJobpost('');">View Job Post</a>-->
