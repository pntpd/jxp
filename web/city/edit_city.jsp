...
<html:form action="/city/CityAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row d-none1">
                                    ...
                                    <div class="row col-lg-12">	
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <html:text property="cityName" styleId="cityName" styleClass="form-control" maxlength="100"/>
