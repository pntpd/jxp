...
<html:form action="/competencyassessments/CompetencyassessmentsAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${competencyassessmentsForm.competencyassessmentsId <= 0}">
                                        Assessment Type
                                    </c:when>
                                    <c:otherwise>
                                        Assessment Type
                            ...
                            <div class="body-background">
                                <div class="row d-none1">
                                    <div class="col-lg-12">
                                        ...
                                        <h6><b>ADD/EDIT ASSESSMENT TYPE</b></h6>
                                    ...
                                    <div class="row col-lg-12">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <html:select styleClass="form-select" property="assettypeId" onchange="javascript: setDept('2', '2');">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <html:select styleClass="form-select" property="departmentId" styleId="departmentId">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                            <label class="mt-checkbox mt-checkbox-outline"> Schedule Needed
                                                    <html:checkbox property="schedule" styleClass="form-check-input" value="1" />
                                                    <span></span>
                                            </label>
                                        </div>
