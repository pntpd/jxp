...
<html lang="en">
    ...
    <%
            ...
            int count = 0;
            int recordsperpage = competencyassessments.getCount();
            ...
            int showsizelist = competencyassessments.getCountList("show_size_list");
            int CurrPageNo = 1;
    ...
    <head>
        <meta charset="utf-8">
        <title><%= competencyassessments.getMainPath("title") != null ? competencyassessments.getMainPath("title") : "" %></title>
        ...
        <script type="text/javascript" src="../jsnew/competencyassessments.js"></script>
        <script type="text/javascript" src="../jsnew/validation.js"></script>
    </head>
    <body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
    <html:form action="/competencyassessments/CompetencyassessmentsAction.do" onsubmit="return false;">
        <html:hidden property="doAdd"/>
        <html:hidden property="doModify"/>
        <html:hidden property="doView"/>    
        <html:hidden property="competencyassessmentsId"/>
        <!-- Begin page -->
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <label for="example-text-input" class="col-sm-5 col-form-label text-right">Asset Type:</label>
                                                            <div class="col-sm-7 field_ic">
                                                                <html:select styleClass="form-select" property="assettypeIdIndex" onchange="javascript: setDept('1', '1');">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <label for="example-text-input" class="col-sm-5 col-form-label text-right">Department:</label>
                                                            <div class="col-sm-7 field_ic">
                                                                <html:select styleClass="form-select" property="departmentIdIndex" styleId="departmentIdIndex" onchange="javascript: searchFormAjax('s','-1');">
                                                                    <html:optionsCollection property="departments" value="ddlValue" label="ddlLabel"></html:optionsCollection>
                                                                </html:select>
                                                            </div>
                                                        </div>
                                                    </div>                                                
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="body-background mt_0">
                                    <div class="row" id='ajax_cat'>
                                        ...
                                        <%
                                                                                int competencyassessmentsCount = count;
                                                                                int nextCount = 0;
                                                                                String prev = "";
                                                                                String prevclose = "";
                                                                                String next = "";
                                        ...
                                        <%
                                                                                    if (nextCount == 0 && competencyassessmentsCount > recordsperpage)
                                                                                    {
                                                                                        next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                                                                                        nextclose = ("</i></a></li>");
                                                                                    }
                                                                                    else if (nextCount > 0 && competencyassessmentsCount >
                                                                                        ...
                                                                                        ((nextCount*recordsperpage) + recordsperpage))
                                                                                    {
                                                                                        prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                                                                                        prevclose = ("</i></a></li>");
                                                                                        last = competencyassessmentsCount;
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        recordsperpage = competencyassessmentsCount;
                                                                                    }
                                                                                }
                                                                                else
                                                                                {
                                                                                ...
                                                                                if (recordsperpage > 0)
                                                                                {
                                                                                    noOfPages = competencyassessmentsCount / recordsperpage;
                                                                                    if (competencyassessmentsCount % recordsperpage > 0)
                                                                                        noOfPages += 1;
                                                                                }
                                                                                if(total > 0)
                                                                                {
                                        ...
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=competencyassessmentsCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center"><span><b>Schedule Needed</b></span></th>
...
%>
                                                                <tr class='hand_cursor' href='javascript: void(0);'>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getCompetencyassessmentsId()%>');"><%= info.getName() != null ? info.getName() : ""%></td>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getCompetencyassessmentsId()%>');"><%= info.getAssettypeName() != null ? info.getAssettypeName() : ""%></td>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getCompetencyassessmentsId()%>');"><%= info.getDepartment() != null ? info.getDepartment() : ""%></td>
                                                                    <%if (info.getSchedule() == 1) {%>
                                                                        <td class="primary_active text-center"><i class="fa fa-check" aria-hidden="true"></i></td>
                                                                    <%}else {%> 
                                                                        <td>&nbsp;</td> <%}%>
                                                                    <td>
                                                                        <span class="switch_bth float-end">
                                                                            <div class="form-check form-switch">
                                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getCompetencyassessmentsId()%>', '<%=status%>', '<%=i%>');"/>
                                                                            </div>
                                                                        </span>
                                                                        <% if (editper.equals("Y") && info.getStatus() == 1) {%><a href="javascript: modifyForm('<%= info.getCompetencyassessmentsId()%>');" class="edit_mode float-end mr_15"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                    </td>
                                                                </tr>
<%
                                                            }
