...
<body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
    <html:form action="/crewdayrate/CrewdayrateAction.do" onsubmit="return false;">
...
<%
                                            ...
                                            <div class="wesl_pagination pagination-mg m_15">
                                                <div class="wesl_pg_rcds">
                                                    Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=crewdayrateCount%>)                                                
                                                </div>
...
%>                                                                  
                                                                    <tr class='hand_cursor'>
                                                                        <td class="hand_cursor" onclick="javascript: showDetail('<%=info.getAssetId()%>');"><%= info.getClientName() != null ? info.getClientName() : ""%></td>
                                                                        <td class="hand_cursor" onclick="javascript: showDetail('<%=info.getAssetId()%>');"><%= info.getClientAssetName() != null ? info.getClientAssetName() : ""%></td>
                                                                        <td class="hand_cursor assets_list text-center"><a href='javascript: void(0);' onclick="javascript: showDetail('<%=info.getAssetId()%>');"><%= info.getPcount() %></a></td>
                                                                        <td class="hand_cursor assets_list text-center"><a href='javascript: void(0);' onclick="javascript: showDetail('<%=info.getAssetId()%>');"><%= info.getPendingcount() %></a></td>
                                                                        <td class="action_column" >                                                                          
                                                                            <a class="mr_15" href="javascript: showDetail('<%=info.getAssetId()%>');"><% if(info.getScount() > 0) {%><img src="../assets/images/pencil.png" /><% } else  {%><img src="../assets/images/link.png" /><% } %></a>
                                                                            <span class="switch_bth">
                                                                                <div class="form-check form-switch">
                                                                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y") || info.getScount() <= 0) {%>disabled="true"<% } %> onclick="javascript: changestatus('<%=info.getAssetId()%>', '<%=status%>','<%=i%>');"/>
                                                                              </div>
                                                                            </span>
                                                                        </td>                                                                      
                                                                    </tr>
