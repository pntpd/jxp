...
<html:form action="/doccheck/DoccheckAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${doccheckForm.doccheckId <= 0}">
                                        Add Doc Check
                                    </c:when>
                                    <c:otherwise>
                                        Edit Doc Check
                                ...
                                <div class="row d-none1">
                                    ...
                                    <div class="row col-lg-12">	
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <html:text property="doccheckName" styleId="doccheckName" styleClass="form-control" maxlength="100"/>
                                            <script type="text/javascript">
                                                document.getElementById("doccheckName").setAttribute('placeholder', '');
                                            </script>
                                        </div>     
                                    </div> 
