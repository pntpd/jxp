...
<html:form action="/onboardingkit/OnboardingkitAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${onboardingkitForm.onboardingkitId <= 0}">
                                        Add Onboarding Kit
                                    </c:when>
                                    <c:otherwise>
                                        Edit Onboarding Kit
