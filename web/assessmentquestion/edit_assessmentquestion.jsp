...
<html lang="en">
    ...
    <body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
        <html:form action="/assessmentquestion/AssessmentQuestionAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="float-start">
                                    <a href="javascript:goback();" class="back_arrow">
                                        ...
                                        <c:choose>
                                            <c:when test="${assessmentquestionForm.assessmentquestionId <= 0}">
                                        ...
                                        <div class="row d-none1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                                    ...
                                                    <html:select styleClass="form-select" property="assessmentAnswerTypeId">
                                                        <html:optionsCollection property="assessmentAnswerTypes" value="ddlValue" label="ddlLabel"></html:optionsCollection>
                                                    </html:select>
                                                </div>

                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                        <label class="form_label">Assessment Parameter</label>
                                                        <html:select property="assessmentParameterId" styleClass="form-select">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                                        ...
                                                        <html:text property="link" styleId="link" styleClass="form-control" maxlength="100"/>
                                                        <script type="text/javascript">
                                                            document.getElementById("link").setAttribute('placeholder', '');
                                                        </script>
                                                    </div> 
                                                </div>
