...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title><%= verification.getMainPath("title") != null ? verification.getMainPath("title") : ""%></title>
    ...
    <html:form action="/verification/VerificationAction.do" onsubmit="return false;">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select styleClass="form-select" styleId="tabIndex" property="tabIndex" onchange="javascript: searchFormAjax('s', '-1');" >
                                                            <html:option value="-1">Select Pending Tab</html:option>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select styleClass="form-select" styleId="statusIndex" property="statusIndex" onchange="javascript: searchFormAjax('s', '-1');" >
                                                            <html:option value="-1">Select Status</html:option>
                                                            <html:option value="1">Unverified</html:option>
                                                            <html:option value="3">Minimum Verified</html:option>
                                    ...
                                    <div class="row" id='ajax_cat'>
                                        ...
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages%>, &nbsp;(<%= nextCount * recordsperpage + 1%> - <%= last > 0 ? last : nextCount * recordsperpage + recordsperpage%> record(s) of <%=verificationCount%>)
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="18%" class="text-left"><span><b>Status</b></span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="sort_id">
                                                            <%
                                                            ...
                                                            <tr class='hand_cursor' href='javascript: void(0);'>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getVerificationId()%>');"><%=  info.getIds() != null ? info.getIds() : ""%></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getVerificationId()%>');"><%= info.getEnrollon() != null ? info.getEnrollon() : ""%></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getVerificationId()%>');"><%= info.getName() != null ? info.getName() : ""%></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getVerificationId()%>');"><%= info.getPosition() != null ? info.getPosition() : ""%></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getVerificationId()%>');"><span <% if((info.getFlagstatusId() ==4 || info.getFlagstatusId() ==3) && info.getFlagav() >0){ %>class="com_verified"<%}%>><%= info.getFlagstatus() != null ? info.getFlagstatus() : ""%></span></td>
                                                            </tr>
                                                            <%
                                                                    }
                                                                }
