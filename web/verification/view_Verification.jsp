                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-9 col-md-8 col-sm-8 col-12 candi_info">
                                                                    <ul>
                                                                        ...
                                                                        <li><span><% if ((info.getContact1() != null && !info.getContact1().equals("")) || (info.getContact2() != null && !info.getContact2().equals(""))) {%><%= info.getContact1_code() != null && !info.getContact1_code().equals("") ? info.getContact1_code() : ""%> <%= info.getContact1() != null && !info.getContact1().equals("") ? info.getContact1() : "&nbsp;"%><% if (info.getContact2() != null && !info.getContact2().equals("")) {%> | <%= info.getContact2_code() != null && !info.getContact2_code().equals("") ? info.getContact2_code() : ""%> <%= info.getContact2()%> <% }
                                                                            }%></span></li>
