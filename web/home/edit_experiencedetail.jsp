...
<%
        ...
        if (session.getAttribute("FILENAME1") != null)
        {
            ...
            if(filename1 != null && !filename1.equals(""))
                filename1 = candidate.getMainPath("view_candidate_file")+filename1;
        }
                                    ...
                                    <div class="body-background">
                                        <div class="row d-none1">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-6 form_group">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                                        ...
                                                        <html:select property="assettypeId" styleClass="form-select" onchange="javascript: setAssetPosition();">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                                        ...
                                                        <html:select property="countryId" styleId="countryId" styleClass="form-select">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group" id="all_workenddate">
