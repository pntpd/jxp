                                    ...
                                    <div class="row d-none1">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                                <label class="form_label">Vaccination Name<span class="required">*</span></label>
                                                <html:select property="vaccinationNameId" styleClass="form-select">
                                                    <html:optionsCollection filter="false" property="vacinationnames" label="ddlLabel" value="ddlValue">
                                                    </html:optionsCollection>
                                                </html:select>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                                <label class="form_label">Vaccination Type<span class="required">*</span></label>
                                                <html:select property="vacinationTypeId" styleClass="form-select">
                                                    <html:optionsCollection filter="false" property="vaccinationtypes" label="ddlLabel" value="ddlValue">
                                                    </html:optionsCollection>
                                                </html:select>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                                <div class="row flex-end align-items-end">
                                                    <div class="col-lg-10 col-md-12 col-sm-12 col-12 form_group">
                                                        <label class="form_label">Place of Application (City)<span class="required">*</span></label>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                                <label class="form_label">Date of Application<span class="required">*</span></label>
                                                <div class="input-daterange input-group">
                                                    <html:text property="dateofapplication" styleId="dateofapplication" styleClass="form-control add-style wesl_dt date-add" />
                                                    <script type="text/javascript">
                                                        document.getElementById("dateofapplication").setAttribute('placeholder', 'DD-MMM-YYYY');
                                                    </script>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-6 form_group">
                                                <label class="form_label">Attach Certificate (5MB) (.pdf/.jpeg/.png)<span class="required">*</span></label>
                                                <html:file property="vaccinedetailfile" styleId="upload1" onchange="javascript: setClass('1');"/>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12" id="submitdiv">
                                            <a href="javascript:submitvaccinatonform();" class="save_btn"><img src="../assets/images/save.png"> Save</a>
                                            <a href="javascript: openTab('5');" class="cl_btn"><i class="ion ion-md-close"></i> Close</a>
                                        </div>
            ...
            $(function ()
            {
                $("#cityName").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: "/jxp/ajax/home/autofillcity_vaccination.jsp",
                            type: 'post',
                            dataType: "json",
