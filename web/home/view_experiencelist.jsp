                                        ...
                                        <div class="row">
                                            ...
                                            <div class="main-heading">
                                                ...
                                                <div class="pull_right float-end">
                                                    ...
                                                    if(ipass ==2){}else{
                                                    %>
                                                    <a href="javascript: modifyexperienceForm(-1);" class="add_btn"><i class="mdi mdi-plus"></i></a><% }%>
                                                </div>
                                            </div>
                                        </div>
                                                            <div class="col-lg-12">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="action_column">                                                                                    
                                                                                    ...
                                                                                    if(ainfo.getPassflag() ==2){}else{
                                                                                        ...
                                                                                        if ( ainfo.getStatus() == 1) {%><a href="javascript: modifyexperienceForm('<%= ainfo.getExperiencedetailId()%>');" class="mr_15"><img src="../assets/images/pencil.png"/></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>
                                                                                    <%}%>
