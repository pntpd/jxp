...
<html:form action="/currency/CurrencyAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${currencyForm.currencyId <= 0}">
                                        Add Currency
                                    </c:when>
                                    <c:otherwise>
                                        Edit Currency
