...
<jsp:useBean id="ticket" class="com.web.jxp.dashboard.Ticket" scope="page"/>
<!doctype html>
<html lang="en">
<%
try 
...
<%
    ...
    String url = "";
    if(request.getAttribute("TURL") != null)
    {
        url = (String) request.getAttribute("TURL");
        request.removeAttribute("TURL");
    }  
    if(!url.equals(""))
    {
        String ticketval = ticket.getUrl();
        url += "?qlikTicket=" + ticketval;
    }
%>
<head>
    <meta charset="utf-8">
...
<body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
    <html:form action="/analytics/AnalyticsAction.do" onsubmit="return false;" enctype="multipart/form-data">
        <html:hidden property="doTraining" />
                    ...
                    <div class="row head_title_area">
                        <div class="col-md-12 col-xl-12">
                            <div class="float-start">
                                <span class="back_arrow">Training Analytics</span>
                            </div>
                            <div class="float-end">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-1">
                                                <a href="javascript: searchtraining();" class="go_btn">Go</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
