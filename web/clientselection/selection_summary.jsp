...
<html lang="en">
    ...
    <%
        ...
        ClientselectionInfo info = null, cinfo = null, einfo = null;;
        ...
        if (request.getAttribute("CANDIDATESUMMARY") != null) {
            cinfo = (ClientselectionInfo) request.getAttribute("CANDIDATESUMMARY");
        }

        if (request.getAttribute("CANDIDATEEMAILSUMMARY") != null) {
            einfo = (ClientselectionInfo) request.getAttribute("CANDIDATEEMAILSUMMARY");
        }

        ArrayList maillog_list = new ArrayList();
        if (request.getAttribute("SUMMARYEMAILLOG") != null) {
            maillog_list = (ArrayList) request.getAttribute("SUMMARYEMAILLOG");
        }
        int maillogtotal = maillog_list.size();

        ArrayList offerlog_list = new ArrayList();
        if (request.getAttribute("SUMMARYOFFERLOG") != null) {
            offerlog_list = (ArrayList) request.getAttribute("SUMMARYOFFERLOG");
        }
        int offerlogtotal = offerlog_list.size();
                                ...
                                <div class="body-background com_checks">
                                    ...
                                    <div class="row com_checks_main">
                                        <div class="col-md-12 com_top_right">
                                            <div class="row d-flex align-items-center">
                                                <div class="col-md-6 com_label_value">
                                                    <div class="row mb_0">
                                                ...
                                                <div class="col-md-3 com_label_value">
                                                    <div class="row mb_0">
                                                        ...
                                                        <div class="col-md-8"><span><%=clientselection.changeNum(info.getJobpostId(), 6)%></span></div>
                                                    </div>
                                                    <div class="row mb_0">
                                                        <div class="col-md-4"><label>Posting Date</label></div>
                                                        <div class="col-md-8"><span><%=info.getDate()%></span></div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4"><label>Experience</label></div>
                                                        <div class="col-md-8"><span><%=info.getExpMin()%>-<%=info.getExpMax()%> Yrs</span></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="ref_vie_ope status_value client_sec_area">
                                                        <ul>
                                                            <li class="com_ope_job">Status <span><%if (info.getStatus() == 1) {%>Open<%} else if (info.getStatus() == 3) {%>Close<%}%></span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                    ...
                                    <%}
                                        if (cinfo != null) {
                                            String tempImg = "";
                                            String classAddone = "";
                                            String tempclass = "status_on_hold";
                                            String tempclass1 = "client_se_vi_re";
                                    %>
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 short_list_area">
                                                    <div class="row client_head_search">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12"><h2>CANDIDATES <span>- Compliance Checks Complete</span></h2></div>
                                                    </div>
                                                    <div class="search_short_main client_sel_candidate1 single_list">
                                                        <ul>
                                                            <li class="odd_list_1">
                                                                <div class="search_box">
                                                                    ...
                                                                    if ((cinfo.getSflag() == 4 && cinfo.getSubstatus() != 3) || cinfo.getSflag() == 5){
                                                                        ...
                                                                        %>
                                                                        <div class="col-md-3 add_view_area <%=tempclass1%>">
                                                                            <div class="row">
                                                                                <div class="search_add_btn">
                                                                                    ...
                                                                                    %> <a href="javascript: getSelectCandidate('<%=cinfo.getName().replaceAll("'", "")%>','<%=cinfo.getCountry()%>','<%=clientselection.changeNum(info.getJobpostId(), 6)%>','<%=cinfo.getShortlistId()%>');">Select</a>
                                                                                    <%} else if (cinfo.getSflag() == 4 && cinfo.getSubstatus() == 1) {
                                                                                    %> <a href="javascript: getGenerateoffer('<%= cinfo.getShortlistId()%>','<%= cinfo.getSflag()%>','<%= cinfo.getCandidateId()%>','<%= cinfo.getSubstatus()%>');">Generate Offer</a>
                                                                                    <%} else if (cinfo.getSflag() == 4 && cinfo.getSubstatus() == 2) {
                                                                                    ...
                                                                                    <%} else if (cinfo.getSflag() == 4 && cinfo.getSubstatus() == 3) {
                                                                                    %> <a href="javascript:;" onclick="getsetModal('<%= cinfo.getShortlistId()%>', '<%= cinfo.getCandidateId()%>', '0', '0');" data-bs-toggle="modal" data-bs-target="#acc_offer_letter_modal">Accept</a>
                                                                                    <%}%>
                                                                                </div>
                                                                                <% if (cinfo.getSflag() == 4 && (cinfo.getSubstatus() == 4 || cinfo.getSubstatus() == 5)) {
                                                                                ...
                                                                                classAddone = "";
                                                                                if (cinfo.getSflag() == 2 || (cinfo.getSflag() == 4 && (cinfo.getSubstatus() == 1 ||  cinfo.getSubstatus() == 2 || cinfo.getSubstatus() == 4 || cinfo.getSubstatus() == 5)) || cinfo.getSflag() == 5){
                                                                                    classAddone = "1";
                                                                                    }
                                                                                %>
                                                                                <div class="search_view_prof com_view_job with_reject<%=classAddone%> d-none1">
                                                                                    <%  if (cinfo.getSflag() == 2 || cinfo.getSflag() == 3) {%>
                                                                                    <a href="javascript: getGenerateCV('<%= cinfo.getShortlistId()%>','<%= cinfo.getSflag()%>','<%= cinfo.getCandidateId()%>');"><img src="../assets/images/view.png"><br> View Generated CV</a>	
                                                                                        <% } else if ((cinfo.getSflag() == 4 && cinfo.getSubstatus() == 1) || cinfo.getSflag() == 5) {%>
                                                                                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#view_pdf" onclick="javascript: setIframe('<%=(cvfile_path+cinfo.getPdffileName())%>');"><img src="../assets/images/view.png"/><br> View Generated CV</a>
                                                                                        <% } else if (cinfo.getSflag() == 4 && (cinfo.getSubstatus() == 1 || cinfo.getSubstatus() == 2 || cinfo.getSubstatus() == 3)) {%>
                                                                                    <a href="javascript: getGenerateoffer('<%= cinfo.getShortlistId()%>','<%= cinfo.getSflag()%>','<%= cinfo.getCandidateId()%>','<%= cinfo.getSubstatus()%>');"><img src="../assets/images/view.png"/><br> View Offer Letter</a>
                                                                                        <%}%>
                                                                                </div>
                                                                                <%}%>
                                                                                <% if (cinfo.getSflag() == 3) {%>
                                                                                <div class="search_view_prof client_reject">
                                                                                    <a href="javascript:;" onclick="getsetModal('<%= cinfo.getShortlistId()%>', '<%= cinfo.getCandidateId()%>', '0', '0');" data-bs-toggle="modal" data-bs-target="#reject_modal">Reject</a>	
                                                                                </div>
                                                                                <%} else if (cinfo.getSflag() == 4 && cinfo.getSubstatus() == 3) {%>
                                                                                <div class="search_view_prof client_reject">
                                                                                    <a href="javascript:;" onclick="getsetModal('<%= cinfo.getShortlistId()%>', '<%= cinfo.getCandidateId()%>', '<%= cinfo.getSflag()%>', '<%= cinfo.getSubstatus()%>');" data-bs-toggle="modal" data-bs-target="#dec_offer_letter_modal">Decline</a>
                                                                                </div>
                                                                                <%} else if (cinfo.getSflag() == 4 && (cinfo.getSubstatus() == 4 || cinfo.getSubstatus() == 5)) {
                                                    ...
                                                    <div class="search_short_main com_label_value single_list">
                                                        <ul>
                                                           ...
                                                           if (maillogtotal > 0) {
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="full_width veri_details">
                                                                            <%
                                                                            for (int i = 0; i < maillogtotal; i++) {
                                                                            minfo = (ClientselectionInfo) maillog_list.get(i);
                                                                            if (minfo != null) {
                                                                            %>
                                                                            <ul>
                                                                                <li><%=minfo.getMailon()%></li>
                                                                                <li class="circle_ic"><span>&nbsp;</span></li>
                                                                                <li><%=minfo.getMailby()%></li>
                                                                                <li class="circle_ic"><span>&nbsp;</span></li>
                                                                                <li>
                                                                                    <%
                                                                                   if(minfo.getMaillogId() >0){
                                                                                    %>
                                                                                    <a href="javascript: getEmailSummaryDetails('<%=minfo.getMaillogId()%>', '<%=cinfo.getSflag()%>', '<%=cinfo.getShortlistId()%>');">View Record</a>
                                                                                    <%
                                                                                     } else {
                                                                                    %>
                                                            ...
                                                            if (offerlogtotal > 0) {
                                                               ClientselectionInfo oinfo;
                                                            %>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Offer Letter(s)</label></div>
                                                                    <div class="col-md-9">
                                                                        <div class="full_width veri_details">
                                                                            <%
                                                                            for (int i = 0; i < offerlogtotal; i++) {
                                                                            oinfo = (ClientselectionInfo) offerlog_list.get(i);
                                                                            if (oinfo != null) {
                                                                            %>
                                                                            <ul>
                                                                                <li><%=oinfo.getMailon()%></li>
                                                                                <li class="circle_ic"><span>&nbsp;</span></li>
                                                                                <li><%=oinfo.getMailby()%></li>
                                                                                <li class="circle_ic"><span>&nbsp;</span></li>
                                                                                <li>
                                                                                    <%
                                                                                    if(!oinfo.getPdffileName().equals("")){
                                                                                    %>
                                                                                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#view_pdf" onclick="javascript: setIframe('<%=(oinfo.getPdffileName())%>');">View Record</a>
                                                                                    <%
                                                                                     } else {
                                                                                    %>
                                                                                    <span>No offer letter attached</span>
                                                                                    <%}%>
                                                                                </li>
                                                                            </ul>
                                                                            <%
                                                           ...
                                                           if ((cinfo.getSflag() == 4 && cinfo.getSubstatus() == 4) || (cinfo.getSflag() == 4 && cinfo.getSubstatus() == 5)) {
                                                            ClientselectionInfo orinfo = clientselection.getOfferReasonDetails(cinfo.getShortlistId());
                                                            %>
                                                            <li>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <b>
                                                                            <%if (cinfo.getSflag() == 4 && cinfo.getSubstatus() == 4) {
                                                                            %>Yes
                                                                            <%} else if (cinfo.getSflag() == 4 && cinfo.getSubstatus() == 5) {
                                                                            %>No
                                                                            <%}%></b><br/><br/>
                                                                            <%if(orinfo != null){%>
                                                                        <p>
                                                                            <%=orinfo.getPositionValue()%> <%if(!orinfo.getPositionValue().equals("") && !orinfo.getDdlLabel().equals("")){%>- <%}%><%=orinfo.getDdlLabel()%>
                                                                        </p>
                                                                        <%
                                                                        }
                                                                        %>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 short_list_area">
                                                    ...
                                                    <div class="search_short_main com_label_value" id="demailsummary">
                                                        <%if (einfo != null) {%>
                                                        <ul>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>User Type</label></div>
                                                                    <div class="col-md-9"><span><%= companytype == 1 ? "Company" : "Client"%></span></div>
                                                                </div>	
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Sent On</label></div>
                                                                    <div class="col-md-9"><span><%=cinfo.getMailon()%></span></div>
                                                                </div>	
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Sent By</label></div>
                                                                    <div class="col-md-9"><span><%=cinfo.getMailby()%></span></div>
                                                                </div>	
                                                            </li>
                                                            <%if (cinfo.getSflag() == 4) {%>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Selected On</label></div>
                                                                    <div class="col-md-9">
                                                                        <span><%=cinfo.getSron()%></span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Selected By</label></div>
                                                                    <div class="col-md-9"><span><%=cinfo.getSrby()%></span></div>
                                                                </div>	
                                                            </li>
                                                            <%} 
                                                                    if (cinfo.getSflag() == 5) {
                                                                    ClientselectionInfo rinfo = clientselection.getRejectReasonDetails(cinfo.getShortlistId());
                                                            %>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Rejected On</label></div>
                                                                    <div class="col-md-9">
                                                                        <span><%=rinfo.getSrDate()%></span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Rejected By</label></div>
                                                                    <div class="col-md-9"><span><%=rinfo.getSrBy()%></span></div>
                                                                </div>	
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Reasons</label></div>
                                                                    <div class="col-md-9"><%=clientselection.getSeparatedString(rinfo.getReason())%>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9"><span><%=rinfo.getRemark()%></span></div>
                                                                </div>
                                                            </li>
                                                            <%
                                                            } else {
                                                            ...
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Email Overview</label></div>
                                                                    <div class="col-md-9">
                                                                        <span><%=einfo.getSubject()%><br/><br/> <%=mailbody%></span>
                                                                    </div>
                                                                </div>	
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Sent To</label></div>
                                                                    <div class="col-md-9"><span><%=einfo.getClientmailId()%></span></div>
                                                                </div>	
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Sent CC</label></div>
                                                                    <div class="col-md-9"><span><%=einfo.getComailId()%></span></div>
                                                                </div>	
                                                            </li>
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-md-3"><label>Sent BCC</label></div>
                                                                    <div class="col-md-9"><span><%=einfo.getBccmailId()%></span></div>
                                                                </div>	
                                                            </li>
                                                            <%}%>
                                                        </ul>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        <a href="javascript: view('<%=info.getJobpostId()%>', '<%=companytype%>');" class="save_btn">Go to Selection</a>
                                    </div>
                                </div>
                            </div>
                        </div> 
