                            ...
                            <div class="search_export_area">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 text-right">
                                        <a href="javascript: resetFilter();" class="reset_export mr_5"><img src="../assets/images/refresh.png"> Reset Filters</a>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        ...
                                                        <tbody id="sort_id">
                                                            ...
                                                            <tr class='hand_cursor' href='javascript: void(0);'  >
                                                                ...
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getJobpostId()%>', '<%=companytype%>');"><%= info.getClientName() != null ? info.getClientName() : ""%></td>
                                                                ...
                                                                <td class="assets_list text-center hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getJobpostId()%>', '<%=companytype%>');"><a class="selec_grey_value" href="javascript:void(0);"><%= info.getSelcount()%></a>&nbsp;/&nbsp;<a class="off_total_value" href="javascript:void(0);"><%= info.getOpening()%></a></td>
