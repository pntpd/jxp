...
<html:form action="/qualificationtype/QualificationTypeAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${qualificationtypeForm.qualificationtypeId <= 0}">
                                        Add Education Kind
                                    </c:when>
                                    <c:otherwise>
                                        Edit Education Kind
