...
<body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
    <html:form action="/timesheet/TimesheetAction.do" onsubmit="return false;">
                                        ...
                                        <div class="row mb-3">      
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9 field_ic">
                                                        <html:select property="typevalue" styleId="typevalue" styleClass="form-select" onchange="javascript: searchFormAjax('s', '-1');">
...
<%
                                            ...
                                            <div class="wesl_pagination pagination-mg m_15">
                                                <div class="wesl_pg_rcds">
                                                    Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=timesheetCount%>)                                                
                                                </div>
...
%>                                                                  
                                                                    <tr class='hand_cursor'>
                                                                        ...
                                                                        <td class="hand_cursor text-center" onclick="javascript: showDetail('<%=info.getAssetId()%>');"><%= info.getTypevalue() != null ? info.getTypevalue() : "" %></td>                                                                                                                                            
                                                                        <td class="hand_cursor assets_list text-center"><a href='javascript: void(0);' onclick="javascript: showDetail('<%=info.getAssetId()%>');"><%= info.getTcount() %></a></td>
                                                                    </tr>
<%
                                                                }
                                                            }
