...
<html:form action="/approvedby/ApprovedbyAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${approvedbyForm.approvedbyId <= 0}">
                                        Add Course Approved By
                                    </c:when>
                                    <c:otherwise>
                                        Edit Course Approved By
                                    </c:otherwise>
                                </c:choose>
                            </a>
                        </div>
