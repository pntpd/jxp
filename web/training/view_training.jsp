...
<%
        ...
        if(request.getAttribute("TRAINING_DETAIL") != null)
            info = (TrainingInfo)request.getAttribute("TRAINING_DETAIL");
%>  
<head>
    <meta charset="utf-8">
...
<html:form action="/training/TrainingAction.do" onsubmit="return false;" styleClass="form-horizontal">
            ...
            <div class="page-content">
                <div class="row head_title_area">
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start"><a href="javascript: goback();" class="back_arrow"><img  src="../assets/images/back-arrow.png"/> View Priority</a></div>
                        <div class="float-end">                            
...
%>
                                    <div class="row col-lg-12">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <span class="form-control"><%= training.getStatusById(info.getStatus()) %></span>
                                        </div>
                                    </div>                                    
<%
                                    }
