...
<html lang="en">
    ...
    <%
            ...
            else
            {
                ...
                int count = 0;
                int recordsperpage = onboarding.getCount();
                ...
                int showsizelist = onboarding.getCountList("show_size_list");
                int CurrPageNo = 1;
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        ...
                                                        <tbody id="sort_id">
                                                            ...
                                                            <tr class='hand_cursor' href='javascript: void(0);'  >
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getClientId()%>', '<%= info.getClientassetId()%>', '<%= info.getCountryId()%>');"><%= info.getClientName() != null ? info.getClientName() : ""%></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getClientId()%>', '<%=info.getClientassetId()%>', '<%= info.getCountryId()%>');"><%= info.getCountry() != null ? info.getCountry() : ""%></td>
                                                                <td class="assets_list text-center hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getClientId()%>', '<%=info.getClientassetId()%>', '<%= info.getCountryId()%>');"><a href="javascript:void(0);"><%=  onboarding.changeNum( info.getOnboardCount(),2)%></a>&nbsp;/&nbsp;<a href="javascript:void(0);"><%=  onboarding.changeNum( info.getTotalnoofopenings(),2)%></a></td>
                                                                                ...
                                                                                <div class="dropdown_menu">
                                                                                    <div class="dropdown-wrapper">
                                                                                        <div class="category-menu">
                                                                                            <a href="javascript: ViewAsset('<%= info.getClientId()%>');">View Asset</a>
