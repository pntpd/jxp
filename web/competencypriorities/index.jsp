...
<html lang="en">
    ...
    <%
            ...
            int count = 0;
            int recordsperpage = competencypriorities.getCount();
            ...
            int showsizelist = competencypriorities.getCountList("show_size_list");
            int CurrPageNo = 1;
    ...
    <html:form action="/competencypriorities/CompetencyprioritiesAction.do" onsubmit="return false;">
                                                ...
                                                <div class="row">                                                    
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9 field_ic">
                                                                <html:select property="clientIdIndex" styleId="clientIdIndex" styleClass="form-select" onchange="javascript: setAssetDDL('1', '1');" >
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9 field_ic">
                                                                <html:select property="assetIdIndex" styleId="assetIdIndex" styleClass="form-select" onchange="javascript: setList();">
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="body-background mt_0">
                                    <div class="row" id='ajax_cat'>
                                        ...
                                        <%
                                                                                int competencyprioritiesCount = count;
                                                                                int nextCount = 0;
                                                                                String prev = "";
                                                                                String prevclose = "";
                                                                                String next = "";
                                        ...
                                        <%
                                                                                    if (nextCount == 0 && competencyprioritiesCount > recordsperpage)
                                                                                    {
                                                                                        next = ("<li class='next'><a href=\"javascript: searchFormAjax('n','-1')\" title='First'><i class='fa fa-angle-right'>");
                                                                                        nextclose = ("</i></a></li>");
                                                                                    }
                                                                                    else if (nextCount > 0 && competencyprioritiesCount >
                                                                                        ...
                                                                                        ((nextCount*recordsperpage) + recordsperpage))
                                                                                    {
                                                                                        prev = ("<li class='prev'><a href=\"javascript: searchFormAjax('p','-1')\" title='Prev'><i class='fa fa-angle-left'>");
                                                                                        prevclose = ("</i></a></li>");
                                                                                        last = competencyprioritiesCount;
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        recordsperpage = competencyprioritiesCount;
                                                                                    }
                                                                                }
                                                                                else
                                                                                {
                                                                                ...
                                                                                if (recordsperpage > 0)
                                                                                {
                                                                                    noOfPages = competencyprioritiesCount / recordsperpage;
                                                                                    if (competencyprioritiesCount % recordsperpage > 0)
                                                                                        noOfPages += 1;
                                                                                }
                                                                                if(total > 0)
                                                                                {
                                        ...
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=competencyprioritiesCount%>)                                                
                                            </div>
                                                ...
                                                <div class="table-responsive mb-0" data-bs-pattern="priority-columns">        
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th width="18%">
                                                                    <span><b>Competency Priority</b></span>
                                                                ...
                                                                <th width="11%" class="text-right"><span><b>Actions</b></span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="sort_id">
<%
...
%>
                                                                <tr class='hand_cursor' >
                                                                    <td class="hand_cursor" onclick="javascript: showDetail('<%= info.getCompetencyprioritiesId()%>');"><%= info.getName() != null ? info.getName() : ""%></td>
                                                                    <td class="hand_cursor" onclick="javascript: showDetail('<%= info.getCompetencyprioritiesId()%>');"><%= competencypriorities.getPrioritDegreeById(info.getDegreeId())%></td>
                                                                    <td class="hand_cursor" onclick="javascript: showDetail('<%= info.getCompetencyprioritiesId()%>');"><%= info.getClientName() != null ? info.getClientName() : ""%></td>
                                                                    <td class="hand_cursor" onclick="javascript: showDetail('<%= info.getCompetencyprioritiesId()%>');"><%= info.getAssetName() != null ? info.getAssetName() : ""%></td>
                                                                    <td class="hand_cursor" onclick="javascript: showDetail('<%= info.getCompetencyprioritiesId()%>');"><%= info.getDeptColumn() != null ? info.getDeptColumn() : ""%></td>
                                                                    
                                                                    <td>
                                                                        <span class="switch_bth float-end">
                                                                            <div class="form-check form-switch">
                                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getCompetencyprioritiesId()%>', '<%=status%>', '<%=i%>');"/>
                                                                            </div>
                                                                        </span>
                                                                        <% if (editper.equals("Y") && info.getStatus() == 1) {%><a href="javascript: modifyForm('<%= info.getCompetencyprioritiesId()%>');" class="edit_mode float-end mr_15"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                    </td>
                                                                </tr>
<%
                                                            }
