...
<%
        ...
        if(request.getAttribute("COMPETENCYPRIORITIES_DETAIL") != null)
            info = (CompetencyprioritiesInfo)request.getAttribute("COMPETENCYPRIORITIES_DETAIL");
%>
<head>
    <meta charset="utf-8">
...
<html:form action="/competencypriorities/CompetencyprioritiesAction.do" onsubmit="return false;" styleClass="form-horizontal">
            ...
            <div class="page-content">
                <div class="row head_title_area">
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start"><a href="javascript: goback();" class="back_arrow"><img  src="../assets/images/back-arrow.png"/> View Competency Priorities</a></div>
                        <div class="float-end">                            
                        ...
                        <div class="col-md-12 col-xl-12">
                            <div class="body-background">
                                <div class="row d-none1">  
                                    <h6><b>VIEW COMPETENCY PRIORITIES</b></h6>
                                    <h6>&nbsp;</h6>
<%
                                    if(info != null)
                                    {
%>
                                    <div class="row col-lg-12">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <span class="form-control"><%= (info.getDeptColumn() != null && !info.getDeptColumn().equals("")) ? info.getDeptColumn() : "&nbsp;" %></span>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <span class="form-control"><%= competencypriorities.getPrioritDegreeById(info.getDegreeId())%></span>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <span class="form-control"><%= competencypriorities.getStatusById(info.getStatus()) %></span>
                                        </div>
                                    </div>                                    
<%
                                    }
