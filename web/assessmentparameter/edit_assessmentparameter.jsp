...
<html lang="en">
    ...
    <body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
        <html:form action="/assessmentparameter/AssessmentParameterAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="float-start">
                                    <a href="javascript:goback();" class="back_arrow">
                                        ...
                                        <c:choose>
                                            <c:when test="${assessmentParameterForm.assessmentParameterId <= 0}">
                                                Add Assessment Parameter
                                            </c:when>
                                            <c:otherwise>
                                                Edit Assessment Parameter
                                            </c:otherwise>
                                        </c:choose>
                                    </a>
                                </div>
                                        ...
                                        <div class="row d-none1">
                                            ...
                                            <div class="row col-lg-12">											
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                                    ...
                                                    <html:textarea property="description" styleId="description" styleClass="form-control" rows="4"/>
                                                    <script type="text/javascript">
