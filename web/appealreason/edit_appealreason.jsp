...
<html:form action="/appealreason/AppealreasonAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${appealreasonForm.appealreasonId <= 0}">
                                        Add Competency Result
                                    </c:when>
                                    <c:otherwise>
                                        Edit Competency Result
                                    </c:otherwise>
                                </c:choose>
                            </a>
                        </div>
