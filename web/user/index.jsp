                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="row">
                                                    <label for="example-text-input" class="col-sm-7 col-form-label text-right">Sort By Client Access:</label>
                                                    <div class="col-sm-5 field_ic">
                                                        <html:select property="clientIndex" styleId="clientIndex" styleClass="form-select">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="row">
                                                    <div class="col-sm-3 field_ic">
                                                        <div class="form-check permission-check">
                                                            <html:checkbox property="permissionIndex" styleClass="form-check-input" value="Y" />
                                                        </div>
                                                    </div>
                                                    <label for="example-text-input" class="col-sm-9 col-form-label">Is Admin</label>
                                    ...
                                    <div class="col-lg-4 text-right">
                                        <a href="javascript:resetFilter();" class="reset_export mr_10"><img src="../assets/images/refresh.png"> Reset Filters</a>
                                    ...
                                    <div class="row" id='ajax_cat'>
                                        ...
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=userCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center"><span><b>Is Admin</b></span></th>
                                                        ...
                                                        <tbody id="sort_id">
                                                            ...
                                                            <tr class="hand_cursor" href='javascript: void(0);'>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getUserId()%>');"><%= info.getCode() %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getUserId()%>');"><%= info.getName() != null ? info.getName() : "" %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getUserId()%>');"><%= info.getContact1() != null ? info.getContact1() : "" %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getUserId()%>');"><%= info.getEmail() != null ? info.getEmail() : "" %></td>
                                                                <% if( info.getPermission().equals("Y")) {%><td class="primary_active text-center"><i class="fa fa-check" aria-hidden="true"></i></td><% } else {%><td><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a></td><%}%>
                                                                <td>
                                                                    <span class="switch_bth float-end">
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getUserId()%>', '<%=status%>', '<%=i%>');"/>
                                                                        </div>
                                                                    </span>
                                                                    <% if (editper.equals("Y") && info.getStatus() == 1) {%><a href="javascript: modifyForm('<%= info.getUserId()%>');" class="edit_mode float-end mr_15"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                </td>
                                                            </tr>
                                                            <%
                                                                                                                        }
