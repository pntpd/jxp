                        ...
                        <div class="row head_title_area">
                            <div class="col-md-12 col-xl-12">
                                <div class="float-start">
                                    <a href="javascript: backtoold();" class="back_arrow"><img src="../assets/images/back-arrow.png"/>Privacy Policy</a>
                                </div>
                                <div class="float-end">
                            ...
                            <div class="col-md-12 col-xl-12 tab_head_area">
                                ...
                                <li id='list_menu1' class='list_menu1 nav-item active'>
                                    <a class='nav-link' href="javascript:;">
                                        <span class='d-none d-md-block'>Privacy Policy</span><span class='d-block d-md-none'><i class='mdi mdi-home-variant h5'></i></span>
                                    </a>
                                </li>
                                </ul>
                            </div>
                                ...
                                <div class="col-md-12 col-xl-12">
                                    <div class="body-background">
                                        <div class="row d-none1">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 about_privacy_area">
