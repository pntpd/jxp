...
<html:form action="/bank/BankAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row d-none1">
                                    ...
                                    <div class="row col-lg-12">											
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <html:text property="branch" styleId="branch" styleClass="form-control" maxlength="200"/>
                                        </div>                                        
                                    </div>
                                    <div class="row col-lg-12">											
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            <label class="form_label">A/C No</label>
                                            <html:text property="accno" styleId="accno" styleClass="form-control" maxlength="50"/>
                                        </div>                                        
                                    </div>
                                    <div class="row col-lg-12">											
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            <label class="form_label">IFSC Code</label>
                                            <html:text property="ifsc" styleId="ifsc" styleClass="form-control" maxlength="50"/>
                                        </div>                                        
                                    </div>
