...
<body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
    <html:form action="/crewdb/CrewdbAction.do" onsubmit="return false;">
                ...
                <div class="page-content">
                    <div class="row head_title_area">
                        <div class="col-md-12 col-xl-12">
                            ...
                            <div class="float-end">  
                                <!--<a href="javascript:;" class="add_user mr_25">Advance Filter</a>-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9 field_ic">
                                                        <html:text property ="search" styleId="example-text-input" styleClass="form-control" maxlength="200" onkeypress="javascript: handleKeySearch(event);"/>
                                                        <a href="javascript: searchFormAjax('s','-1');" class="input-group-text"><i class="mdi mdi-magnify"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 list_field_150 pd_5">
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select property="positionIndex" styleClass="form-select">
                                            ...
                                            <div class="col-lg-2 list_field list_field_145 pd_5">
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select property="clientIdIndex" styleClass="form-select" onchange="javascript: setCountryDDL();">
                                            ...
                                            <div class="col-lg-2 list_field list_field_150 pd_5">
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select property="countryIdIndex" styleId="countryIdIndex" styleClass="form-select" onchange="javascript: setAssetDDL();">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select property="assetIdIndex" styleId="assetIdIndex" styleClass="form-select">
                                                            <html:option value='-1'>Select Asset</html:option>                                                            
                                            ...
                                            <div class="col-lg-2 list_field list_field_145 pd_5">
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select property="statusIndex" styleClass="form-select">
                                                            <html:option value="-1">Select Status</html:option>
                                                            <html:option value="2">Employed</html:option>
                                                            <html:option value="1">Unemployed</html:option>
                                                        </html:select>
                                                    </div>
                                                </div>
                                            </div>
...
%>
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=crewdbCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="8%" class="text-center"><span><b> </b></span></th>
                                                                <th width="8%" class="text-center"><span><b>Employment Status</b></span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="sort_id">
<%
...
%>
                                                            <tr class='hand_cursor' href='javascript: void(0);'>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCrewdbId()%>');"><%= crewdb.changeNum(info.getCrewdbId(),6) %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCrewdbId()%>');"><%= info.getName() != null ? info.getName() : "" %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCrewdbId()%>');"><%= info.getPosition() != null ? info.getPosition() : "" %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCrewdbId()%>');"><%= info.getClientName() != null ? info.getClientName() : "" %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCrewdbId()%>');"><%= info.getCountryName() != null ? info.getCountryName() : "" %></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCrewdbId()%>');"><%= info.getAssetName() != null ? info.getAssetName() : "" %></td>
                                                                <td class="action_column">     
                                                                <a href="javascript:;" onclick="javascript: viewimg('<%=info.getCrewdbId()%>');" class="mr_15" data-bs-toggle="modal" data-bs-target="#view_resume_list"><img src="../assets/images/attachment.png"></a>
                                                                <td class="text-center">
                                                                    <img class="cer_img" src="<%if(status == 2) {%>../assets/images/active_status.png<% }else { %>../assets/images/inactive_status.png<% } %>"/>
                                                                </td>                                                                
                                                            </tr>
<%
                                                            }
