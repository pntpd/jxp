...
<html:form action="/vaccine/VaccineAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${vaccineForm.vaccineId <= 0}">
                                        Add Vaccination Name
                                    </c:when>
                                    <c:otherwise>
                                        Edit Vaccination Name
                                    </c:otherwise>
                                </c:choose>
                            </a>
                        </div>
