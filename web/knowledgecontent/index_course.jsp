                                                    ...
                                                    <div class="tab-pane active" id="tab2" role="tabpanel">
                                                        ...
                                                        <div class="main-heading m_30 just_cont_inherit list_heading">
                                                            ...
                                                            <div class="pull_right float-end">
                                                                <% if (addper.equals("Y") && (cinfo != null && cinfo.getStatus() == 1)) {%><a href="javascript: addcourseForm();" class="add_btn"><i class="mdi mdi-plus"></i></a> <%}%>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="table-rep-plugin sort_table">
                                                                    <div class="table-responsive mb-0" data-bs-pattern="priority-columns">        
                                                                        <table class="table table-striped">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th width="29%"><span><b>Module</b></span></th>
                                                                                    <th width="29%"><span><b>Topics</b></span></th>
                                                                                    <th width="12%" class="text-right"><span><b>Actions</b></span></th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody id="sort_id">
                                                                                <%
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="action_column">
                                                                                        ...
                                                                                        <% if (editper.equals("Y") && status == 1&& substatus == 1) {%><a href="javascript: modifycourseForm('<%= info.getCourseId()%>','<%= info.getSubcategoryId()%>');" class="mr_15"><img src="../assets/images/pencil.png"/></a><% }%>
                                                                                        <% if (editper.equals("Y") && substatus == 1) {%>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <h3>Knowledge Topic Created</h3>
                                    <p>Your Knowledge material has been added!</p>
                                    <a href="javascript: goback();" class="msg_button" style="text-decoration: underline;">Knowledge Base</a>
                                </div>
                            </div>
                        </div>
                    </div>
