...
<html lang="en">
    ...
    <%
        ...
        String view_path = knowledgecontent.getMainPath("view_trainingfiles");
        KnowledgecontentInfo info = null;
        if (request.getAttribute("CREATETRAINING_DETAIL") != null) {
            info = (KnowledgecontentInfo) request.getAttribute("CREATETRAINING_DETAIL");
        }
    %>  
    <head>
        <meta charset="utf-8">
    ...
    <html:form action="/knowledgecontent/KnowledgecontentAction.do" onsubmit="return false;" styleClass="form-horizontal">
                ...
                <div class="page-content tab_panel">
                    <div class="row head_title_area">
                        <div class="col-md-12 col-xl-12">
                            <div class="float-start"><a href="javascript: showcategory();" class="back_arrow"><img  src="../assets/images/back-arrow.png"/> View Content Management</a></div>
                            <div class="float-end">                            
                        ...
                        <div class="col-md-12 col-xl-12 tab_head_area disable_menu">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-12">
                                <div class="body-background">
                                    <div class="row d-none1"><div class="main-heading">
                                            <div class="add-btn">
                                                <h4>&nbsp;</h4>
                                            </div>
                                            <div class="edit_btn pull_right float-end">
                                                <a href="javascript: modifyForm('<%= info.getCategoryId()%>')"><img src="../assets/images/edit.png"></a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <%
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 form_group">
                                                ...
                                                <span class="form-control"><%= info.getDescription()%></span>
                                            </div>
                                            <%
                                                }
                                            %>
