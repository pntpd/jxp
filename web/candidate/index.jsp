...
<html lang="en">
    ...
    <body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
        <html:form action="/candidate/CandidateAction.do" onsubmit="return false;">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="row">
                                                                <div class="col-sm-12 field_ic">
                                                                    <html:select property="assettypeIdIndex" styleId="assettypeIdIndex" styleClass="form-select" onchange="javascript: getPositionRank();">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="row">
                                                                <div class="col-sm-12 field_ic">                                                                
                                                                    <html:select property="positionIdIndex" styleId="positionIdIndex" styleClass="form-select" onchange="javascript: searchFormAjax('s','-1');">
                                                        ...
                                                        <div class="col-lg-2">
                                                            <div class="row">
                                                                <div class="col-sm-12 field_ic">
                                                                    <html:select styleClass="form-select" property="onlineFlag" onchange="javascript: searchFormAjax('s','-1');">
                                                                        <html:option value="0">- Select -</html:option>
                                                                        <html:option value="1">Company</html:option>
                                                                        <html:option value="2">Self</html:option>
                                                                    </html:select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <div class="row">
                                                                <div class="col-sm-12 field_ic">
                                                                    <html:select styleClass="form-select" property="statustype" onchange="javascript: searchFormAjax('s','-1');">
                                                                        <html:option value="0">- Status -</html:option>
                                                                        <html:option value="1">Open</html:option>
                                                                        <html:option value="2">Certified</html:option>
                                                                    </html:select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <table id="tech-companies-1" class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th width="12%">
                                                                        ...
                                                                        <a href="javascript: sortForm('7', '2');" id="img_7_2" class="sort_arrow deactive_sort"><i class="ion ion-ios-arrow-up"></i></a>
                                                                        <a href="javascript: sortForm('7', '1');" id="img_7_1" class="sort_arrow deactive_sort"><i class="ion ion-ios-arrow-down"></i></a>
                                                                    </th>
                                                            ...
                                                            <tbody id="sort_id">
                                                                ...
                                                                <tr class='hand_cursor' href='javascript: void(0);'  >
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCandidateId()%>');"><%= candidate.changeNum( info.getCandidateId(),6) %></td>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCandidateId()%>');"><%= info.getDate() != null ? info.getDate() : "" %></td>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCandidateId()%>');"><%= info.getName() != null ? info.getName() : "" %></td>                                                                
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCandidateId()%>');"><%= info.getCountryName() != null ? info.getCountryName() : ""%></td>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCandidateId()%>');"><%= info.getCity() != null ? info.getCity() : ""%></td>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCandidateId()%>');"><%= info.getPosition() != null ? info.getPosition() : ""%></td>
                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: view('<%= info.getCandidateId()%>');"><%= info.getOnlineStatus() != null ? info.getOnlineStatus() : ""%></td>
                                                                    <td class="action_column">                                                                    

                                                                        <% if (status == 1) {%><a href="javascript:;" onclick="javascript: viewimg('<%=info.getCandidateId()%>', '<%=info.getFirstname().replaceAll("['\"&\\s]", "")%>');" class="mr_15" data-bs-toggle="modal" data-bs-target="#view_resume_list"><img src="../assets/images/attachment.png"></a><% }%>
                                                                            <%  if(info.getPassflag() ==2 || info.getPassflag() ==3){}else{
                                                                        if (editper.equals("Y") && status == 1) {%><a href="javascript: modifyForm('<%= info.getCandidateId()%>');" class=" mr_15"><img src="../assets/images/pencil.png"/></a><% } }%>
                                                                        <span class="switch_bth">                                           
                                                                            <div class="form-check form-switch">
                                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%> checked <% }%> <% if(!editper.equals("Y") || info.getPassflag() ==2 || info.getPassflag() ==3) {%> disabled="true" <% } %> onclick="javascript: deleteForm('<%= info.getCandidateId()%>', '<%=status%>', '<%=i%>');"/>
                                                                            </div>
                                                                        </span>
                                                                    </td>
                                                                </tr>                                                         
