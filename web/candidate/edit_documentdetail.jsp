    ...
    <body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
        <html:form action="/candidate/CandidateAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-10 col-md-12 col-sm-12 col-12 form_group">
                                                        ...
                                                        <html:text property="cityName" styleId="cityName" styleClass="form-control" maxlength="100" onblur="if (this.value == '') {document.forms[0].placeofapplicationId.value='0';}"/>
                                                        <script type="text/javascript">
           ...
           function setClassRes()
               {
                   if (trim(document.candidateForm.fname.value) != "")
                ...
                init: function () {
                    this.on("addedfile", function (file) {
                        ...
                        reader.onload = function (event) {
                            ...
                            document.candidateForm.fname.value = val;
                            document.candidateForm.localFile.value = localfname;
                        };
                    ...
                    this.on("error", function (file, message) {
                            ...
                            reader.onload = function (event) {
                                var base64String = event.target.result;
                                var val1 = document.candidateForm.fname.value;
                                var fval = val1.replace("@#@" + base64String + "@#@", "");
                                fval = fval.replace("@#@" + base64String, "");
                                fval = fval.replace(base64String + "@#@", "");
                                fval = fval.replace(base64String, "");
                                val = fval;
                                document.candidateForm.fname.value = fval;
                                
                                var localFileval = document.candidateForm.localFile.value;
