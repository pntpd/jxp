                                        ...
                                        <div class="row d-none1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    ...
                                                    <html:text property="savingAccountNo" styleId="savingAccountNo" styleClass="form-control" maxlength="50" onkeypress="return allowPositiveNumber1(event);"/>
                                                    <script type="text/javascript">
                                                        document.getElementById("savingAccountNo").setAttribute('placeholder', '');
                                                    </script>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    <label class="form_label">Account Holder Name<span class="required">*</span></label>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    ...
                                                    <html:text property="IFSCCode" styleId="IFSCCode" styleClass="form-control" maxlength="50"/>
                                                    <script type="text/javascript">
