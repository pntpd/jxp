                                                            ...
                                                            <div class="row">
                                                                <div class="main-heading">
                                                                    ...
                                                                    <div class="pull_right float-end">
                                                                       <%
                                                                if(ipass ==2){}else{
                                                                  if(addper.equals("Y")) {%> <a href="javascript: modifyeducationForm(-1);" class="add_btn"><i class="mdi mdi-plus"></i></a><% } }%>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="action_column">                                                                                        
                                                                                        ...
                                                                                        if(ainfo.getPassflag() ==2){}else{
                                                                                            ...
                                                                                            if (editper.equals("Y") && ainfo.getStatus() == 1) {%><a href="javascript: modifyeducationForm('<%= ainfo.getEducationdetailId()%>');" class="edit_mode mr_15"><img src="../assets/images/pencil.png"/></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>
                                                                                        <%}%>
                                                                                        
                                                                                        <span class="switch_bth">
                                                                                            <div class="form-check form-switch">
                                                                                                <input class="form-check-input" type="checkbox" <% if(ainfo.getPassflag() ==2){%>disabled<%}%> role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1){%> checked <% }%> <% if(!editper.equals("Y")) {%> disabled="true" <% } %>  onclick="javascript: deleteeducationForm('<%= ainfo.getEducationdetailId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                                            </div>
                                                                                        </span>
