                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="main-heading">
                                                ...
                                                <div class="pull_right float-end">
                                                    <%
                                                        if(ipass ==2){}else{
                                                        if(addper.equals("Y")) {%> <a href="javascript: modifyvaccinationdetailForm(-1);" class="add_btn mr_25"><i class="mdi mdi-plus"></i></a> 
                                                        <% } }
                                                        %>
                                                </div>
                                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="action_column">                                                                       
                                                                    <% if(!ainfo.getVaccinecertfile().equals("")) {%><a href="javascript:;" class="mr_15" data-bs-toggle="modal" data-bs-target="#view_pdf" onclick="javascript: setIframe('<%=file_path+ainfo.getVaccinecertfile() %>');"><img src="../assets/images/attachment.png"/> </a><% } else { %><a href='javascript:;'><span style='width: 35px;'>&nbsp;</span></a><% } %>
                                                                        ...
                                                                        if (editper.equals("Y") && ainfo.getStatus() == 1) {%><a href="javascript: modifyvaccinationdetailForm('<%= ainfo.getCandidatevaccineId()%>');" class=" mr_15"><img src="../assets/images/pencil.png"/></a><% }else { %><a href='javascript:;'><span style='width: 35px;'>&nbsp;</span></a><% } %>
                                                                        <%}%>
                                                                    <span class="switch_bth">                                           
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" role="switch" <% if(ainfo.getPassflag() ==2){%>disabled<%}%> id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1){%> checked <% }%> <% if(!editper.equals("Y")) {%> disabled="true" <% } %> onclick="javascript: deletevaccinationForm('<%= ainfo.getCandidatevaccineId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                        </div>
                                                                    </span>
                                                                </td>
                                                            </tr>    
