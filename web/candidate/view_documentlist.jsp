                                                        ...
                                                        <div class="row">
                                                            <div class="main-heading">
                                                                ...
                                                                <div class="pull_right float-end">
                                                                    <a href="javascript: exporttoexcelnew();" class="document_type">Document Check</a> 
                                                                    <%
                                                                if(ipass ==2){}else{
                                                                  if(addper.equals("Y")) {%> <a href="javascript: modifydocumentdetailForm(-1);" class="add_btn"><i class="mdi mdi-plus"></i></a> <% } }%>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                                ...
                                                                                <td class="action_column">                                                                       
                                                                                    <% if (ainfo.getFilecount() > 0) {%><a class="mr_15" href="javascript:;" onclick="javascript: viewimgdoc('<%=ainfo.getGovdocumentId()%>');"  data-bs-toggle="modal" data-bs-target="#view_resume_list"><img src="../assets/images/attachment.png"></a><% } else {%>&nbsp;<% } %>
                                                                                        <%
                                                                                         ...
                                                                                         if (editper.equals("Y") && ainfo.getStatus() == 1) {%><a href="javascript: javascript: modifydocumentdetailForm('<%= ainfo.getGovdocumentId()%>');" class=" mr_15"><img src="../assets/images/pencil.png"/></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>
                                                                                        <%}%>

                                                                                    <span class="switch_bth">                                           
                                                                                        <div class="form-check form-switch">
                                                                                            <input class="form-check-input" type="checkbox" <% if(ainfo.getPassflag() ==2){%>disabled<%}%> role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1){%> checked <% }%> <% if(!editper.equals("Y")) {%> disabled="true" <% } %>  onclick="javascript: deletedocumentForm('<%= ainfo.getGovdocumentId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                                        </div>
                                                                                    </span>
                                                                                </td>
