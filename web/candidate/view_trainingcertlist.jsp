                                                            ...
                                                            <div class="row">
                                                                <div class="main-heading ">
                                                                    ...
                                                                    <div class="pull_right float-end">
                                                                        <%
                                                                    if(ipass ==2){}else{
                                                                     if(addper.equals("Y")) {%> <a href="javascript: modifytrainingcertdetailForm(-1);" class="add_btn"><i class="mdi mdi-plus"></i></a> 
                                                                            <% } }%>
                                                                    </div>
                                                                </div>
                                                                                            ...
                                                                                            <td class="action_column">                                                                                    
                                                                                                <% if(!filep.equals("")) {%><a href="javascript:;" class="mr_15" data-bs-toggle="modal" data-bs-target="#view_pdf" onclick="javascript: setIframe('<%=filep %>');"><img src="../assets/images/attachment.png"/> </a><% } else if(!url.equals("")) {%><a href="<%=url%>" class="mr_15" target="_blank"><img src="../assets/images/attachment.png"/> </a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>
                                                                                                    <%
                                                                                                     ...
                                                                                                     if (editper.equals("Y") && ainfo.getStatus() == 1) {%><a href="javascript: modifytrainingcertdetailForm('<%= ainfo.getTrainingandcertId()%>');" class="edit_mode mr_15"><img src="../assets/images/pencil.png"/></a><% }else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>
                                                                                                    <%}%>
                                                                                                <span class="switch_bth">
                                                                                                    <div class="form-check form-switch">
                                                                                                        <input class="form-check-input" type="checkbox" role="switch" <% if(ainfo.getPassflag() ==2){%>disabled<%}%> id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1){%> checked <% }%> <% if(!editper.equals("Y")) {%> disabled="true" <% } %>  onclick="javascript: deletetrainingcertForm('<%= ainfo.getTrainingandcertId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                                                    </div>
                                                                                                </span>
                                                                                            </td>
                                                                                        </tr>    
