...
<html:form action="/experiencewaterdepth/ExperienceWaterDepthAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${experiencewaterdepthForm.experiencewaterdepthId <= 0}">
                                        Add Water Depth
                                    </c:when>
                                    <c:otherwise>
                                        Edit Water Depth
                                ...
                                <div class="row d-none1">
                                    ...
                                    <div class="row col-lg-12">	
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <html:text property="unitMeasurement" styleId="unitMeasurement" styleClass="form-control" maxlength="100"/>
                                            <script type="text/javascript">
                                                document.getElementById("unitMeasurement").setAttribute('placeholder', '');
                                            </script>
                                        </div>   
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            <label class="form_label">Depth</label>
                                            <html:text property="depth" styleId="depth" styleClass="form-control" maxlength="100"  />
                                            <script type="text/javascript">
                                                document.getElementById("depth").setAttribute('placeholder', '');
                                            </script>
                                        </div>                                        
