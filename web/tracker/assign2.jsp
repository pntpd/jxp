...
<html lang="en">
    ...
    <%
            ...
            int pcodeId = 0;
            if(request.getAttribute("TRACKER_INFO2") != null)
            {
                info = (TrackerInfo) request.getAttribute("TRACKER_INFO2");
                if(info != null)
                    pcodeId = info.getPcodeId();
                request.removeAttribute("TRACKER_INFO2");
            }
            ArrayList list = new ArrayList();
            if(session.getAttribute("ASSIGNLIST2") != null)
            {
                list = (ArrayList) session.getAttribute("ASSIGNLIST2");
            }
                                ...
                                <div class="float-end">   
                                    <div class="role mr_25">
                                        ...
                                        <select class="form-select select_role" name='mode_top' id="mode_top" onchange="javascript: gotomode();">
                                            ...
                                            <option value="2" selected>Role Competency List</option>
                                        </select>
                                    </div>
                                            ...
                                            <div class="row d-flex align-items-center">
                                                <div class="col-md-5 com_label_value">
                                                    <div class="row d-flex align-items-center mb_0">
                                                        ...
                                                        <div class="col-md-7 com_label_value">
                                                            <div class="row mb_0">
                                                                <div class="col-md-4"><label>Role Competency</label></div>
                                                                <div class="col-md-8"><span><%= (info != null && info.getRole() != null ? info.getRole() : "") %></span></div>
                                                            </div>
                                                            <div class="row mb_0">
                                                                <div class="col-md-4"><label>Positions</label></div>
                                                                <div class="col-md-8"><span><%= info.getTotal() %></span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="ref_vie_ope onshore cou_una_pen_com track_total_comp">
                                                        <ul class=" d-flex align-items-center">
                                                            <li class="tot_comp_width">
                                                                ...
                                                                <div class="full_width tot_com"><span>Personnel</span></div>
                                                                <div class="full_width tot_com_value"><span><%=tracker.changeNum(total, 2)%></span></div>
                                                            </li>
                                                            <li class="unassigned_bg mob_value">Unassigned <span><%=tracker.changeNum((total - inprogress - pass - fail - appeals), 2)%></span></li>
                                                ...
                                                <div class="col-md-1">
                                                    <div class="ref_vie_ope">
                                                        <ul>
                                                            <li class="com_view_job"><a href="/jxp/pcode/PcodeAction.do" target="_blank"><img src="../assets/images/view.png"><br> View Competency</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-lg-2 col-md-2 col-sm-3 col-12 mr_15">
                                                                        <html:select property="positionId2Index" styleId="positionId2Index" styleClass="form-select" onchange="javascript: searchFormDetail2();">
                                                    ...
                                                    <div class="table-rep-plugin sort_table">
                                                        <div class="table-responsive mb-0 ellipse_code">
                                                            <table id="tech-companies-1" class="table table-striped">
                                                                <thead>
                                                                    <tr>  
                                                                        <th width="34%"><span><b>Personnel Names</b></span></th>
                                                                        <th width="23%"><span><b>Position - Rank</b></span></th>
                                                                        <th width="18%"><span><b>Status</b></span></th>
                                                                        <th width="4%" class="text-center">
                                                                            <div class="toggled-off_02 usefool_tool" id='togid'>
                                                                                ...
                                                                                <div class="toggle-content">
                                                                                    <ul>
                                                                                        <li class=""><a href="javascript: setfilter2('-1');"><span id="spansel-1" class="round_circle circle_courses selected_circle"></span> All Competencies</a></li>
                                                                                        <li><a href="javascript: setfilter2('1');"><span id="spansel1" class="round_circle circle_unassigned"></span> Unassigned</a></li>
                                                                                        <li><a href="javascript: setfilter2('2');"><span id="spansel2" class="round_circle circle_pending "></span> In Progress</a></li>
                                                                                        <li><a href="javascript: setfilter2('3');"><span id="spansel3" class="round_circle circle_pending"></span> Completed</a></li>
                                                                                        <li><a href="javascript: setfilter2('4');"><span id="spansel4" class="round_circle circle_complete"></span> Competent</a></li>
                                                                                        <li><a href="javascript: setfilter2('5');"><span id="spansel5" class="round_circle circle_exipred"></span> Not Yet Competent</a></li>
                                                                                        <li><a href="javascript: setfilter2('6');"><span id="spansel6" class="round_circle circle_exipry"></span> Appealed</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>	
                                                                        </th>
                                                                        <th width="10%"><span><b>Valid Till</b></span></th>
                                                                        <th width="5%"><span><b>Score</b></span></th>
...
%>
                                                                        <tr>
                                                                            ...
                                                                            <td><%if(minfo.getAverage() > 0) {%><%= minfo.getAverage() %><% } else { %>-<% } %></td>
                                                                            <td class="action_column text-center"><%if(addper.equals("Y") || editper.equals("Y")){%><%if(minfo.getTrackerId() > 0) {%><a class="" data-bs-toggle="modal" data-bs-target="#unassigned_details_modal_01" href="javascript:;" onclick="javascript: updatetracker('<%=minfo.getTrackerId()%>','2','<%=minfo.getPositionId()%>');"><img src="../assets/images/view.png"/></a><% } else {%><a class="" data-bs-toggle="modal" data-bs-target="#unassigned_details_modal_01" href="javascript:;" onclick="javascript: setPersonalModal('<%=minfo.getCandidateId()%>','<%=minfo.getTrackerId()%>','<%=pcodeId%>','2','<%=minfo.getPositionId()%>');"><img src="../assets/images/view.png" /></a><% } %><% } else {%>&nbsp;<% } %></td>
                                                                        </tr>
<%
                                                                        }
                                                                    }
