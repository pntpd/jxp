                                        ...
                                        <div class="row d-flex align-items-center">
                                            ...
                                            <div class="col-md-2 pd_0">
                                                <div class="ref_vie_ope onshore exp_pos_per">
                                                    <ul>
                                                        <li class="positions_bg mob_value">Positions <span><%=tracker.changeNum(total_positions, 2)%></span></li>
                                                        <li class="personnel_bg mob_value">Personnel <span><%=tracker.changeNum(total_candidate, 2)%></span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <div class="ref_vie_ope">
                                                    <ul>
                                                        <li class="com_view_job"><a href="javascript: ;" onclick=" javascript: gotoCompetency();"><img src="../assets/images/view.png"><br> View&nbsp;Detail</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-9">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="row">
                                                                        <label for="example-text-input" class="col-sm-3 col-form-label text-right">Mode:</label>
                                                                        <div class="col-sm-9 field_ic">
...
%>
                                                                        <tr>
                                                                            <td class="hand_cursor" onclick="javascript: assign1('<%=info.getCandidateId()%>', '<%=info.getPositionId()%>');"><%=info.getName() != null ? info.getName() : ""%></td>
                                                                            <td class="hand_cursor" onclick="javascript: assign1('<%=info.getCandidateId()%>', '<%=info.getPositionId()%>');"><%=info.getPositionName() != null ? info.getPositionName() : ""%></td>
                                                                            <td class="assets_list text-center">
                                                                                <a href="javascript:;" onclick="javascript: assign1('<%=info.getCandidateId()%>', '<%=info.getPositionId()%>');" class="selec_grey_value"><%=tracker.changeNum(info.getPcount(),2)%></a>&nbsp;/&nbsp;
                                                                                <a href="javascript:;" onclick="javascript: assign1('<%=info.getCandidateId()%>', '<%=info.getPositionId()%>');" class="off_total_value"><%=tracker.changeNum(info.getTotal(),2)%></a>
                                                                            </td>
                                                                            <td class="text-center">
                                                                                <div class="main-nav">
                                                                                    <ul>
                                                                                        <li class="drop_down vie_rol_com">
                                                                                            <a href="javascript:;" class="toggle"><i class="fas fa-ellipsis-v"></i></a>
                                                                                            <div class="dropdown_menu">
                                                                                                <div class="dropdown-wrapper">
                                                                                                    <div class="category-menu">
                                                                                                        <a href="javascript: assign1('<%=info.getCandidateId()%> , '<%=info.getPositionId()%>');">View Role Competencies</a>
