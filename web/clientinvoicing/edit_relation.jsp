...
<html:form action="/clientinvoicing/ClientinvoicingAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
    <html:hidden property="clientinvoicingId"/>
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${clientinvoicingForm.clientinvoicingId <= 0}">
                                        Add Invoicing
                                    </c:when>
                                    <c:otherwise>
                                        Edit Invoicing
