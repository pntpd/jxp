                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="body-background com_checks1">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 re_generate">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 form_group">
                                                            ...
                                                            <textarea class="form-control" rows="5"><%= cinfo.getPaymentremark()%></textarea>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                            <div class="row">
                                                                <table width="100%" class="table">
                                                                    <tr>
                                                                        <td width="30%"><label class="form_label">Received On</label></td>
                                                                        <td width="40%"><label class="form_label"><%= cinfo.getPaymentdate()%></label></td>
                                                        ...
                                                        <%if(cinfo.getAttachedfile() != null && !cinfo.getAttachedfile().equals("")) {%>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-4 form_group">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-3 col-sm-6 col-12 text-left">
                                                                <ul class="resume_attach">
                                                                    <li><label class="form_label">Payment Advice</label></li>
                                                                    <li>
                                                                        <a href="javascript:;" class="attache_btn">
                                                                            <i class="fas fa-paperclip"></i> Attachment
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <div class="down_prev">
                                                                            <a href="<%=file_path+cinfo.getAttachedfile() %>" download="paymentadvice" target = '_blank'>Download</a><span class="dot_ic"></span>
                                                                            <a href="<%=file_path+cinfo.getAttachedfile() %>" target = '_blank'>Preview</a>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                <a href="javascript: ;" onclick =" javascript: showDetail('<%= cinfo.getClientassetId()%>');" class="save_btn">Close</a>
                                            </div>
                                        </div>
                                </div>
                            </div>
