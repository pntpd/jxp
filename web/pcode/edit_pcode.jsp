...
<html:form action="/pcode/PcodeAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${pcodeForm.pcodeId <= 0}">
                                ...
                                <div class="row d-none1">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="main-heading m_30">
                                            <div class="add-btn">
                                                <h4>ROLE COMPETENCY DETAILS</h4>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Asset-Type</label>
                                                <html:select styleClass="form-select" property="assettypeId" onchange="javascript: setDept('2');">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                ...
                                                <html:select styleClass="form-select" property="pdeptId" styleId="pdeptId">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Role Competency Code</label>
                                               <html:text property="code" styleId="code" styleClass="form-control" maxlength="50"/>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-8 form_group">
                                                <label class="form_label">Role Competency</label>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 form_group">
                                                ...
                                                <html:textarea property="description" styleId="description" styleClass="form-control" rows="4"></html:textarea>
