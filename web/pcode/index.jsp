...
<html lang="en">
    ...
    <%
            ...
            if(session.getAttribute("PCODE_LIST") != null)
                pcode_list = (ArrayList) session.getAttribute("PCODE_LIST");
    ...
    <html:form action="/pcode/PcodeAction.do" onsubmit="return false;">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    <label for="example-text-input" class="col-sm-4 col-form-label text-right">Asset Type:</label>
                                                    <div class="col-sm-8 field_ic">
                                                        <html:select styleClass="form-select" property="assettypeIdIndex" onchange="javascript: setDept('1');">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    <label for="example-text-input" class="col-sm-4 col-form-label text-right">Department:</label>
                                                    <div class="col-sm-8 field_ic">
                                                        <html:select styleClass="form-select" property="pdeptIdIndex" styleId="pdeptIdIndex" onchange="javascript: searchFormAjax('s','-1');">
                                                            <html:optionsCollection property="pdepts" value="ddlValue" label="ddlLabel"></html:optionsCollection>
                                                        </html:select>
                                                    </div>
                                                </div>
                                            </div>
...
%>
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=pcodeCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-right" width="13%"><span><b>Actions</b></span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="sort_id">
<%
...
%>
                                                                <tr>
                                                                    ...
                                                                    <td><%= info.getCode() != null ? info.getCode() : ""%></td>                                                                    
                                                                    <td><%= info.getAssettypeName() != null ? info.getAssettypeName() : ""%></td>
                                                                    <td><%= info.getDeptName() != null ? info.getDeptName() : ""%></td>
                                                                    <td class="assets_list text-center hand_cursor"> <a href="javascript: showDetail('<%= info.getPcodeId()%>');"><%= info.getQcount()%></a> </td>
                                                                    <td class="action_column">
                                                                        <a class="mr_15" href="javascript: showDetail('<%= info.getPcodeId()%>');"><img src="../assets/images/plus.png"></a>
                                                                        <% if (editper.equals("Y") && info.getStatus() == 1) {%><a class="mr_15" href="javascript: modifyForm('<%= info.getPcodeId()%>');"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                        <span class="switch_bth float-end">
                                                                            <div class="form-check form-switch">
                                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getPcodeId()%>', '<%=status%>', '<%=i%>');"/>
                                                                            </div>
                                                                        </span>                                                                        
                                                                    </td>
                                                                </tr>
