...
%>
    ...
    <html:form action="/invoicetemplate/InvoicetemplateAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 col-xl-12">
                            <div class="float-start">
                                <a href="javascript:goback();" class="back_arrow">
                                    ...
                                    <c:choose>
                                        <c:when test="${invoicetemplateForm.invoicetemplateId <= 0}">
                                    ...
                                    <div class="row d-none1">
                                        ...
                                        <div class="row col-lg-12">	
                                            ...
                                            <div class="form-group form-horizontal">
                                                <label class="control-label col-md-3">Template File Name <span class="required" aria-required="true"></span></label>
                                                <div class="col-md-6 control-label3"><html:text property="description" styleId="description" styleClass="form-control" maxlength="200"/></div>
                                            </div>
                                        </div>
                                    </div>									
