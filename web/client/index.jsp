...
<html lang="en">
    ...
    <%
            ...
            if(session.getAttribute("CLIENT_LIST") != null)
                client_list = (ArrayList) session.getAttribute("CLIENT_LIST");
    ...
    <body data-sidebar="dark" data-keep-enlarged="true" class="vertical-collpsed">
        <html:form action="/client/ClientAction.do" onsubmit="return false;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="row">
                                                        <label for="example-text-input" class="col-sm-4 col-form-label text-right">Location:</label>
                                                        <div class="col-sm-8 field_ic">
                                                            <html:select property="countryIndexId" styleClass="form-select" onchange="javascript: searchFormAjax('s','-1');">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7 field_ic">
                                                            <html:select property="assettypeIndexId" styleClass="form-select" onchange="javascript: searchFormAjax('s','-1');">
                                                                <html:option value="-1">All</html:option>
                                        ...
                                        <div class="row" id='ajax_cat'>
                                            ...
                                            <div class="wesl_pagination pagination-mg m_15">
                                                <div class="wesl_pg_rcds">
                                                    Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=clientCount%>)                                                
                                                </div>
                                                        ...
                                                        <table id="tech-companies-1" class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th width="19%">
                                                                        <span><b>Person In-charge</b></span>
                                                                    ...
                                                                    <th width="6%" class="text-left"><span><b>Assets</b></span></th>
                                                                    <th width="15%" class="text-right"><span><b>Actions</b></span></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="sort_id">
                                                                <%
                                                                ...
                                                                <tr class='hand_cursor' href='javascript: void(0);'>
                                                                    <td class="hand_cursor" href="javascript: void(0);" onclick="javascript: showDetail('<%= info.getClientId()%>');" ><%= client.changeNum(info.getClientId(),3) %></td>
                                                                    <td class="hand_cursor" href="javascript: void(0);" onclick="javascript: showDetail('<%= info.getClientId()%>');" ><%= info.getName() != null ? info.getName() : ""%></td>                                                                
                                                                    <td class="hand_cursor" href="javascript: void(0);" onclick="javascript: showDetail('<%= info.getClientId()%>');" ><%= info.getInchargename() != null ? info.getInchargename() : ""%></td>
                                                                    <td class="hand_cursor" href="javascript: void(0);" onclick="javascript: showDetail('<%= info.getClientId()%>');" ><%= info.getEmail()!= null ? info.getEmail() : ""%></td>
                                                                    <td class="hand_cursor" href="javascript: void(0);" onclick="javascript: showDetail('<%= info.getClientId()%>');" ><%= info.getContact()!= null ? info.getContact() : ""%></td>
                                                                    <td class="assets_list"><a href="javascript: viewasset('<%= info.getClientId()%>');"><%= client.changeNum(info.getAssetcount(),2)%></a></td>
                                                                    <td>
                                                                        <span class="switch_bth float-end">
                                                                            <div class="form-check form-switch">
                                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getClientId()%>', '<%=status%>', '<%=i%>');"/>
                                                                            </div>
                                                                        </span>
                                                                        
                                                                        <% if (editper.equals("Y") && info.getStatus() == 1) {%><a href="javascript: modifyForm('<%= info.getClientId()%>');" class="edit_mode float-end mr_15"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                    </td>
                                                                </tr>
                                                                <%
                                                                                                                            }
