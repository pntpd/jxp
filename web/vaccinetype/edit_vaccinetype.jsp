...
<html:form action="/vaccinetype/VaccinetypeAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${vaccinetypeForm.vaccinetypeId <= 0}">
                                        Add Vaccination Type
                                    </c:when>
                                    <c:otherwise>
                                        Edit Vaccination Type
                                    </c:otherwise>
                                </c:choose>
                            </a>
                        </div>
