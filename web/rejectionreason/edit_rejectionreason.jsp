...
<html:form action="/rejectionreason/RejectionreasonAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${rejectionreasonForm.rejectionreasonId <= 0}">
                            ...
                            <div class="body-background">
                                <div class="row d-none1">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group" >
                                        <label class="control-label col-md-3">Rejection Type:<span class="required" aria-required="true"></span></label>
                                        <div class="mt-radio-inline radio_list">
                                            <label class="mt-radio">
                                                <html:radio property="rejectionType" value="1" /> Rejection
                                                <span></span>
                                            </label>
                                            <label class="mt-radio">
                                                <html:radio property="rejectionType" value="2" /> Declined
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
