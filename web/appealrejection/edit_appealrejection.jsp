...
<html:form action="/appealrejection/AppealrejectionAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${appealrejectionForm.appealrejectionId <= 0}">
                                        Add Appeal Rejection Reason
                                    </c:when>
                                    <c:otherwise>
                                        Edit Appeal Rejection Reason
                                    </c:otherwise>
                                </c:choose>
                            </a>
                        </div>
