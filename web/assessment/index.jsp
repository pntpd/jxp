...
<html lang="en">
    ...
    <%
            ...
            if(session.getAttribute("ASSESSMENT_LIST") != null)
                assessment_list = (ArrayList) session.getAttribute("ASSESSMENT_LIST");
    ...
    <html:form action="/assessment/AssessmentAction.do" onsubmit="return false;">
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    <label for="example-text-input" class="col-sm-6 col-form-label text-right">Parameter:</label>
                                                    <div class="col-sm-6 field_ic">
                                                        <html:select property="assessmentparameterIndex" styleClass="form-select" onchange="javascript: setquestionparameters();">
                                                            <html:optionsCollection filter="false" property="assessmentparameters" label="ddlLabel" value="ddlValue">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    <label for="example-text-input" class="col-sm-6 col-form-label text-right">Question Type:</label>
                                                    <div class="col-sm-6 field_ic">
                                                        <html:select property="questiontypeIndex" styleClass="form-select" styleId="questiontypeIndex">
                                                            <html:optionsCollection filter="false" property="questiontypes" label="ddlLabel" value="ddlValue">
                                                            </html:optionsCollection>
                                                        </html:select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row" id='ajax_cat'>
                                        ...
                                        <div class="wesl_pagination pagination-mg m_15">
                                            <div class="wesl_pg_rcds">
                                                Page&nbsp;<%=CurrPageNo%> of <%= noOfPages %>, &nbsp;(<%= nextCount*recordsperpage + 1 %> - <%= last > 0?last:nextCount*recordsperpage + recordsperpage %> record(s) of <%=assessmentCount%>)                                                
                                            </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        ...
                                                        <tbody id="sort_id">
                                                            ...
                                                            <tr class='hand_cursor' href='javascript: void(0);'>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getAssessmentId()%>');"><%= assessment.changeNum(info.getAssessmentId(),3) %></td> 
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getAssessmentId()%>');"><%= info.getName() != null ? info.getName() : ""%></td>                                                                
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getAssessmentId()%>');"><%= info.getMode() != null ? info.getMode() : ""%></td>
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getAssessmentId()%>');"><%= info.getParaName()!= null ? info.getParaName() : ""%></td>
                                                                <td>
                                                                    <span class="switch_bth float-end">
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if(status == 1){%>checked<% }%> <% if(!editper.equals("Y")) {%>disabled="true"<% } %> onclick="javascript: deleteForm('<%= info.getAssessmentId()%>', '<%=status%>', '<%=i%>');"/>
                                                                        </div>
                                                                    </span>
                                                                    <% if (editper.equals("Y") && info.getStatus() == 1) {%><a href="javascript: modifyForm('<%= info.getAssessmentId()%>');" class="edit_mode float-end mr_15"><img src="../assets/images/pencil.png"/></a><% } %>
                                                                </td>
                                                            </tr>
                                                            <%
                                                                                                                        }
                                                                            ...
                                                                            {
                                                            %>
                                                            <tr><td colspan='6'>No assessments available.</td></tr>
                                                            <%
                                                                                                                                    }
                                                            %>
