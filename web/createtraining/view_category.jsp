...
<%
        ...
        String view_path = createtraining.getMainPath("view_trainingfiles");
        CreatetrainingInfo info = null;
        if(request.getAttribute("CREATETRAINING_DETAIL") != null)
            info = (CreatetrainingInfo)request.getAttribute("CREATETRAINING_DETAIL");
%>  
<head>
    <meta charset="utf-8">
...
<html:form action="/createtraining/CreatetrainingAction.do" onsubmit="return false;" styleClass="form-horizontal">
            ...
            <div class="page-content tab_panel">
                <div class="row head_title_area">
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start"><a href="javascript: showcategory();" class="back_arrow"><img  src="../assets/images/back-arrow.png"/> View Create Trainings</a></div>
                        <div class="float-end">                            
