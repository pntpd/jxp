                                                ...
                                                <div class="tab-pane active" id="tab2" role="tabpanel">
                                                    ...
                                                    <div class="main-heading m_30">
                                                        ...
                                                        <div class="pull_right float-end">
                                                            <% if (addper.equals("Y")) {%><a href="javascript: addsubcategoryForm('-1');" class="add_btn"><i class="mdi mdi-plus"></i></a> <%}%>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="%" class="text-center"><span><b>Courses</b></span></th>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h3>Training Sub-category Created</h3>
                                <p>Go ahead and create topics under the same!</p>
                                <a href="javascript: addcoursesubForm('-1');" class="msg_button" style="text-decoration: underline;">Create Topic</a>
                            </div>
                        </div>
                    </div>
                </div>
