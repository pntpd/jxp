...
<%
        ...
        int count = 0;
        int recordsperpage = createtraining.getCount();
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th  class="text-center"><span><b>Sub-category</b></span>
                                                                ...
                                                                <th  class="text-center"><span><b>Courses</b></span>
...
%>
                                                            <tr class="hand_cursor" href='javascript: void(0);'>
                                                                ...
                                                                <td class="assets_list text-center"><a href="javascript: viewSubcategory('<%= info.getCategoryId()%>');"><%=  createtraining.changeNum( info.getSubcategorycount(),2) %></a></td>
                                                                <td class="assets_list text-center"><a href="javascript: viewCoursecat('<%= info.getCategoryId()%>');"><%=  createtraining.changeNum( info.getCoursecount(),2) %></a></td>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h3>Training Category Created</h3>
                                <p>Go ahead and create sub-category under the same!</p>
                                <a href="javascript: addsubcategoryForm('-1');" class="msg_button" style="text-decoration: underline;">Create Subcategory</a>
                            </div>
                        </div>
                    </div>
                </div>
