...
<html:form action="/country/CountryAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${countryForm.countryId <= 0}">
                                        Add Country
                                    </c:when>
                                    <c:otherwise>
                                        Edit Country
                                ...
                                <div class="row d-none1">
                                    ...
                                    <div class="row col-lg-12">											
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 col-12 form_group">
                                            ...
                                            <html:text property="nationality" styleId="nationality" styleClass="form-control" maxlength="500"/>
                                            <script type="text/javascript">
                                                document.getElementById("nationality").setAttribute('placeholder', '');
                                            </script>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            <label class="form_label">ISD Code</label>
                                            <html:text property="code" styleId="code" styleClass="form-control" maxlength="10"/>
                                            <script type="text/javascript">
