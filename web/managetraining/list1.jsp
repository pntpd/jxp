                                                ...
                                                <div class="col-md-2 pd_0">
                                                    <div class="ref_vie_ope onshore exp_pos_per">
                                                        <ul>
                                                            ...
                                                            <li class="personnel_bg mob_value">Personnel <span><%=managetraining.changeNum(total_candidate, 2)%></span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                            ...
                                                            <table id="tech-companies-1" class="table table-striped">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="17%" class="">
                                                                            <span><b>Percentage Completion</b></span>
...
%>
                                                                                <tr>
                                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: assign1('<%=info.getCandidateId()%>', '<%=info.getPositionId()%>');"><%=info.getName() != null ? info.getName() : ""%></td>
                                                                                    <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: assign1('<%=info.getCandidateId()%>', '<%=info.getPositionId()%>');"><%=info.getPositionName() != null ? info.getPositionName() : ""%></td>
                                                                                    <td class="assets_list text-center">
                                                                                        <a href="javascript:;" class="selec_grey_value"><%=managetraining.changeNum(info.getPcount(),2)%></a>&nbsp;/&nbsp;
                                                                                        <a href="javascript:;" class="off_total_value"><%=managetraining.changeNum(info.getTotal(),2)%></a>
                                                                                    </td>
                                                                                    <td class="hand_cursor text-center" href='javascript: void(0);' onclick="javascript: assign1('<%=info.getCandidateId()%>','<%=info.getPositionId()%>');"><%=managetraining.getDecimal(info.getPercent())%></a>%</td>
                                                                                                    ...
                                                                                                    <div class="dropdown_menu">
                                                                                                        <div class="dropdown-wrapper">
                                                                                                            <div class="category-menu">
                                                                                                                <a href="javascript: assign1('<%=info.getCandidateId()%>');">View Trainings</a>
