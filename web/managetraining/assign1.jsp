...
<html lang="en">
    ...
    <%
            ...
            if(request.getAttribute("MANAGETRAINING_INFO1") != null)
            {
                info = (ManagetrainingInfo) request.getAttribute("MANAGETRAINING_INFO1");
                request.removeAttribute("MANAGETRAINING_INFO1");
            }

            String position = "", poistionId = "";
            int pid =0;
            if (request.getAttribute("MANAGETRAINING_PID") != null) 
            {
                poistionId = (String) request.getAttribute("MANAGETRAINING_PID");
                ...
                request.removeAttribute("MANAGETRAINING_PID");
            }
                                ...
                                <div class="float-end">         
                                    <div class="role mr_25">
                                        ...
                                        <select class="form-select select_role" name='mode_top' id="mode_top" onchange="javascript: gotomode();">
                                            ...
                                            <option value="2">Course List</option>
                                        </select>
                                    </div>
                                                    ...
                                                    <div class="row d-flex align-items-center mb_0">
                                                        <div class="col-md-8">
                                                            <div class="row mb_0">
                                                                ...
                                                                <div class="col-md-7 pd_0"><span><%= info != null && info.getName() != null ? info.getName() : "" %></span></div>
                                                            </div>
                                                            <div class="row mb_0">
                                                                <div class="col-md-5"><label>Position-Rank</label></div>
                                                                <div class="col-md-7 pd_0"><span><%= info != null && position != null ? position : "" %></span></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-lg-1 col align-self-end"><a id="assignhref" href="javascript:;" class="assign_training inactive_btn" data-bs-toggle="modal" data-bs-target="#manage_selected_personal_details_modal" onclick="javascript: setPersonalModalassign();">Assign&nbsp;Training</a> </div>
                                                                    <%}%>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <tr>
                                                                        <th width="3%" class="select_check_box">
                                                                            <label class="mt-checkbox mt-checkbox-outline"> 
                                                                                <input type="checkbox" name="coursecball" id="coursecball" onchange="javascript: setallcb();"/>
                                                                                <span></span>
                                                                            </label>	
                                                                        </th>
                                                                        <th width="4%" class="text-center">
                                                                            <div class="toggled-off_02 usefool_tool" id='togid'>
                                                                                ...
                                                                                <div class="toggle-content">
                                                                                    <ul>                                                                                        
                                                                                        <li class=""><a href="javascript: setfilter('-1');"><span id='spansel-1' class="round_circle circle_courses selected_circle"></span> Total</a></li>
                                                                                        <li><a href="javascript:setfilter('1');"><span id='spansel1' class="round_circle circle_unassigned"></span> Unassigned</a></li>
                                                                                        <li><a href="javascript:setfilter('2');"><span id='spansel2' class="round_circle circle_pending "></span> Pending</a></li>
                                                                                        <li><a href="javascript:setfilter('3');"><span id='spansel3' class="round_circle circle_complete"></span> Complete</a></li>
                                                                                        <li><a href="javascript:setfilter('4');"><span id='spansel4' class="round_circle circle_exipry"></span> Expiry in 45 days</a></li>
                                                                                        <li><a href="javascript:setfilter('5');"><span id='spansel5' class="round_circle circle_exipry"></span> Expiry in 45-65 days </a></li>
                                                                                        <li><a href="javascript:setfilter('6');"><span id='spansel6' class="round_circle circle_exipry"></span> Expiry in 90 days </a></li>
                                                                                        <li><a href="javascript:setfilter('7');"><span id='spansel7' class="round_circle circle_exipred"></span> Expired</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>	
                                                                        </th>
                                                                        <th width="24%"><span><b>Course</b></span></th>
                                                                        <th width="10%"><span><b>Category</b></span></th>
                                                                        <th width="13%"><span><b>Sub-Category</b></span></th>
                                                                        <th width="10%"><span><b>Course Type</b></span></th>
                                                                        <th width="8%"><span><b>Priority</b></span></th>
                                                                        <th width="8%"><span><b>Status</b></span></th>
                                                                        <th width="10%"><span><b>Date</b></span></th>
...
%>
                                                                            ...
                                                                            <%if(minfo.getStatus() != 2){%>
                                                                                        <label class="mt-checkbox mt-checkbox-outline"> 
                                                                                            <input type="checkbox" value="<%=minfo.getCourseId()%>" name="coursecb" class="singlechkbox" onchange="javascript: setcb();" />
                                                                                            <span></span>
                                                                                        </label>
                                                                                    <%} else {%>&nbsp;<%}%>
                                                                                    </td>
                                                                                    <td class="text-center"><%= managetraining.getStColour(minfo.getStatus())%></td>
                                                                                    <td><%= (minfo.getCourseName() != null ? minfo.getCourseName() : "") %></td>
                                                                                    ...
                                                                                    <td class="action_column text-center">
                                                                                        ...
                                                                                        <%if(addper.equals("Y") || editper.equals("Y")){%><a class="" data-bs-toggle="modal" data-bs-target="#personal_course_details_modal_01" href="javascript:;" onclick="javascript: setPersonalModal('-1','<%=minfo.getClientmatrixdetailid()%>','1');"><img src="../assets/images/pencil.png"></a><% } else {%>&nbsp;<% } %>
                                                                                    </td>
                                                                                </tr>
<%
                                                                            }
...
%>
                                                                            <tr><td colspan='11'>No information available.</td></tr>
<%
                                                                        }
%>
                                                                </tbody>
        ...
        <div id="manage_selected_personal_details_modal" class="modal fade parameter_modal large_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" id="personalmodalassign">
                        </div>
                    </div>
                </div>
            </div>
