                                    ...
                                    <div class="col-lg-9">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-sm-12 field_ic">
                                                        <html:select property="pgvalue" styleId="pgvalue" styleClass="form-select" onchange="javascript: searchFormAjax('s', '-1');">
...
%>
                                                            <tr class='hand_cursor' >
                                                                <td class="hand_cursor" onclick="javascript: view('<%= info.getCandidateId()%>', '<%= info.getJobpostId()%>', '<%= info.getShortlistId()%>', '<%= info.getStatus()%>');"><%= compliancecheck.changeNum( info.getJobpostId(),6) %></td>
                                                                <td class="hand_cursor" onclick="javascript: view('<%= info.getCandidateId()%>', '<%= info.getJobpostId()%>', '<%= info.getShortlistId()%>', '<%= info.getStatus()%>');"><%= info.getDate() != null ? info.getDate() : "" %></td>
                                                                <td class="hand_cursor" onclick="javascript: view('<%= info.getCandidateId()%>', '<%= info.getJobpostId()%>', '<%= info.getShortlistId()%>', '<%= info.getStatus()%>');"><%= info.getName() != null ? info.getName() : "" %></td>                                                                
                                                                <td class="hand_cursor" onclick="javascript: view('<%= info.getCandidateId()%>', '<%= info.getJobpostId()%>', '<%= info.getShortlistId()%>', '<%= info.getStatus()%>');"><%= info.getPosition() != null ? info.getPosition() : ""%></td>
                                                                <td class="hand_cursor" onclick="javascript: view('<%= info.getCandidateId()%>', '<%= info.getJobpostId()%>', '<%= info.getShortlistId()%>', '<%= info.getStatus()%>');"><%= info.getClientName() != null ? info.getClientName() : ""%></td>
                                                                <td class="hand_cursor" onclick="javascript: view('<%= info.getCandidateId()%>', '<%= info.getJobpostId()%>', '<%= info.getShortlistId()%>', '<%= info.getStatus()%>');"><%= info.getCcStatus() != null ? info.getCcStatus() : ""%></td>
                                                            </tr>                                                         
<%
                                                            }
                                                        }
