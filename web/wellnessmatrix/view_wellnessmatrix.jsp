            ...
            <div class="page-content">
                <div class="row head_title_area head_fixed">
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start"><a href="javascript: goback();" class="back_arrow"><img  src="../assets/images/back-arrow.png"/> Wellness Matrix</a></div>
                        <div class="float-end">                            
                    ...
                    <div class="col-md-12 metrix_top_right">
                        <div class="row d-flex align-items-center position-relative">
                            ...
                            <div class="col-md-2 com_label_value">
                                <div class="row mb_0">
                                    <div class="col-md-6"><label>Client</label></div>
                                    <div class="col-md-6"><span><%= info.getClientName() != null ? info.getClientName() : "" %></span></div>
                                </div>
                            </div>
                            <div class="col-md-2 com_label_value">
                                <div class="row mb_0">
                                    <div class="col-md-6"><label>Asset</label></div>
                                    <div class="col-md-6"><span><%= info.getClientAssetName() != null ? info.getClientAssetName() : "" %></span></div>
                                </div>
                            </div>
                            <div class="col-md-2 com_label_value">
                                <div class="row mb_0">
...
<%
                                                                if(size > 0)
                                                                {
                                                                    ...
                                                                    {
                                                                        WellnessmatrixInfo minfo = (WellnessmatrixInfo) list.get(i);
                                                                        if(minfo != null)
                                                                        {
                                                                            int status = 0;
...
%>
                                                                            <tr>
                                                                                ...
                                                                                <td class="assets_list text-center"><% if(minfo.getCount1() > 0) {%><a href='javascript:;'><%= wellnessmatrix.changeNum(minfo.getCount1(), 2) %><% } else {%>&nbsp;<% } %></a></td>
                                                                                <td class="assets_list text-center"><% if(minfo.getCount2() > 0) {%><a href='javascript:;'><%= wellnessmatrix.changeNum(minfo.getCount2(), 2) %><% } else {%>&nbsp;<% } %></a></td>
                                                                                <td class="assets_list text-center"><% if(minfo.getCount3() > 0) {%><a href='javascript:;'><%= wellnessmatrix.changeNum(minfo.getCount3(), 2) %><% } else {%>&nbsp;<% } %></a></td>
