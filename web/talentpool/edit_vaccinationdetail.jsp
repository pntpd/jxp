                                ...
                                <div class="body-background">
                                    <div class="row d-none1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <div class="row flex-end align-items-end">
                                                    <div class="col-lg-10 col-md-12 col-sm-12 col-12 form_group">
                                                        <label class="form_label">Place of Application (City)</label>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Date of Application</label>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Attach Certificate (5MB) (.pdf/.jpeg/.png)</label>
