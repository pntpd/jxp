...
<html lang="en">
    ...
    <%
            ...
            if(message != null && (message.toLowerCase()).indexOf("success") != -1)
                ...
                ArrayList mobilization_list = new ArrayList();
            if(request.getAttribute("MOBILIZATIONHISTLIST") != null)
                mobilization_list = (ArrayList) request.getAttribute("MOBILIZATIONHISTLIST");
            int mobilization_list_size = mobilization_list.size();
    %>
    <head>
        <meta charset="utf-8">
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('17');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                                    ...
                                                                    <table class="table table-striped mb-0">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th width="20%">Mobilization Type</th>
                                                                                <th width="10%" class="text-center">Actions</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <%
                                                                            if(mobilization_list_size > 0)
                                                                            {
                                                                                TalentpoolInfo ainfo;
                                                                                for(int i = 0; i < mobilization_list_size; i++)
                                                                                {
                                                                                    ainfo = (TalentpoolInfo) mobilization_list.get(i);
                                                                                    if(ainfo != null)
                                                                                    {
                                                                            %>
                                                                            <tr>
                                                                                <td><%= ainfo.getMobDate() != null && !ainfo.getMobDate().equals("") ? ainfo.getMobDate() : "" %>
                                                                                ...
                                                                                <td><%= ainfo.getType() == 1  ? "Travel" : "Accomodation" %></td>
                                                                                <%if(ainfo.getCrewrotationId() > 0) {%>
                                                                                    <td class="action_column text-center"><a href="javascript:;" onclick="javascript: gotoMob('<%=ainfo.getCrewrotationId()%>', '1');"><img src="../assets/images/view.png"></a></td>
                                                                                <%} else {%>
                                                                                    <td class="action_column text-center">NA</td>
                                                                                <%}%>
                                                                            </tr>  
<%
                                                                                    }
                                                                        ...
                                                                        {
%>
                                                                            <tr><td colspan='7'>No mobilization details available.</td></tr>
<%
                                                                        }
%>
                                                                        </tbody>
