                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('10');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="main-heading">
                                                                ...
                                                                <div class="pull_right float-end">
                                                                    <a href="javascript: exporttoexcelnew('23');" class="document_type">Document Check</a> 
                                                                    <% if(addper.equals("Y") && dstatus != 4) {%> <a href="javascript: modifydocumentdetailForm(-1);" class="add_btn"><i class="mdi mdi-plus"></i></a> <% } %>
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        <tbody>
                                                                            <%
                                                                                        if(doc_list_size > 0)
                                                                                        {
                                                                                            ...
                                                                                            {
                                                                                                ainfo = (TalentpoolInfo) doc_list.get(i);
                                                                                                if(ainfo != null)
                                                                                                {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="action_column">                                                                       
                                                                                    ...
                                                                                    <% if (editper.equals("Y") && ainfo.getStatus() == 1 && dstatus != 4) {%><a href="javascript: javascript: modifydocumentdetailForm('<%= ainfo.getGovdocumentId()%>');" class=" mr_15"><img src="../assets/images/pencil.png"/></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>

                                                                                    <span class="switch_bth">              
                                                                                        <% if (deleteper.equals("Y") && dstatus != 4) {%>
                                                                                        <div class="form-check form-switch">
                                                                                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1){%> checked <% }%> <% if(!editper.equals("Y")) {%> disabled="true" <% } %>  onclick="javascript: deletedocumentForm('<%= ainfo.getGovdocumentId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                                        </div>
                                                                                        <%}%>
                                                                                    </span>
                                                                                </td>
