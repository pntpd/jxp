...
<html lang="en">
    ...
    <%
            ...
            String file_path = talentpool.getMainPath("view_offshore_file");
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('24');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="main-heading">
                                                ...
                                                <div class="pull_right float-end">
                                                    <% if(addper.equals("Y") && dstatus != 4) {%> <a href="javascript: modifyoffshoreForm(-1);" class="add_btn mr_25"><i class="mdi mdi-plus"></i> </a><% } %>
                                                </div>
                                            </div>
                                        </div>
...
<%
                                                        if(offshore_list_size > 0)
                                                        {
                                                            ...
                                                            for(int i = 0; i < offshore_list_size; i++)
                                                            {
                                                                ...
                                                                if(ainfo != null)
                                                                {
                                                                    filename1 = ainfo.getOffshorefile() != null ? ainfo.getOffshorefile() : "";
...
%>
                                                            <tr>
                                                                ...
                                                                <td class="action_column">
                                                                    <% if(!ainfo.getOffshorefile().equals("")) {%><a href="javascript:;" class="mr_15" data-bs-toggle="modal" data-bs-target="#view_pdf" onclick="javascript:setIframe('<%=file_path+ainfo.getOffshorefile() %>');"><img src="../assets/images/attachment.png"/> </a><% } else { %><a href='javascript:;'><span style='width: 35px;'>&nbsp;</span></a><% } %>
                                                                    <% if (editper.equals("Y") && ainfo.getStatus() == 1 && dstatus != 4) {%><a href="javascript: modifyoffshoreForm('<%= ainfo.getOffshoreId()%>');" class="mr_15" ><img src="../assets/images/pencil.png"/></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>

                                                                    <span class="switch_bth">           
                                                                        <% if (deleteper.equals("Y") && dstatus != 4) {%>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1 && dstatus != 4){%> checked <% }%> <% if(!editper.equals("Y")) {%> disabled="true" <% } %>  onchange="javascript: deleteOffshoreForm('<%= ainfo.getOffshoreId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                        </div>
                                                                        <%}%>
                                                                    </span>
                                                                </td>
...
<%
                                                                        ...
                                                                        {
%>
                                                            <tr><td colspan='7'>No offshore details available.</td></tr>
                                                            <%
                                                                                                                                    }
                                                            %>
                                                        </tbody>
