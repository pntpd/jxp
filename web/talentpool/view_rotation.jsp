...
<html lang="en">
    ...
    <%
            ...
            if(request.getAttribute("ROTATIONHISTLIST") != null)
                rotation_list = (ArrayList) request.getAttribute("ROTATIONHISTLIST");
            int rotation_list_size = rotation_list.size();
    %>
    <head>
        <meta charset="utf-8">
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('18');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                                    ...
                                                                    <table class="table table-striped mb-0">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th width="15%">Sign On Date</th>
                                                                                <th width="15%">Sign Off Date</th>
                                                                                <th width="10%">Rotation Status</th>
                                                                                <th width="10%" class="text-center">Actions</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <%
                                                                            if(rotation_list_size > 0)
                                                                            {
                                                                                TalentpoolInfo ainfo;
                                                                                for(int i = 0; i < rotation_list_size; i++)
                                                                                {
                                                                                    ainfo = (TalentpoolInfo) rotation_list.get(i);
                                                                                    if(ainfo != null)
                                                                                    {
                                                                            %>
                                                                            <tr>
                                                                                ...
                                                                                <td><%= ainfo.getPosition() != null && !ainfo.getPosition().equals("") ? ainfo.getPosition() : position %></td>
                                                                                <td><%= ainfo.getSignon() != null && !ainfo.getSignon().equals("") ? ainfo.getSignon() : "" %>
                                                                                <td><%= ainfo.getSignoff() != null && !ainfo.getSignoff().equals("") ? ainfo.getSignoff() : "" %>
                                                                                <td><%= ainfo.getRotationStatusValue() != null && !ainfo.getRotationStatusValue().equals("") ? ainfo.getRotationStatusValue() : "" %></td>
                                                                                <td class="action_column text-center"><a href="javascript: viewrotationActivity('<%=ainfo.getCrewrotationId()%>','<%=ainfo.getClientId()%>','<%=ainfo.getClientassetId()%>');"><img src="../assets/images/view.png">
                                                                            </tr>  
                                                                            <%
                                                                                    }
                                                                                }
                                                                            ...
                                                                            {
                                                                            %>
                                                                            <tr><td colspan='7'>No rotation details available.</td></tr>
                                                                            <%
                                                                            }
                                                                            %>
                                                                        </tbody>
