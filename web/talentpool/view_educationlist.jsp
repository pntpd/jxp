...
<html lang="en">
    ...
    <html:form action="/talentpool/TalentpoolAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
        <html:hidden property="doaddeducationdetail"/>
        <html:hidden property="doSaveeducationdetail"/>
        <html:hidden property="doDeleteeducationdetail"/>
        <html:hidden property="educationdetailId"/>
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('6');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="main-heading">
                                                                ...
                                                                <div class="pull_right float-end">
                                                                    <% if(addper.equals("Y") && dstatus != 4) {%> <a href="javascript: modifyeducationForm(-1);" class="add_btn"><i class="mdi mdi-plus"></i></a><% } %>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <table class="table table-striped mb-0">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th width="32%">Institution, Location</th>
                                                                                <!--<th width="17%">Field of Study</th>-->
                                                                        ...
                                                                        <tbody>
                                                                            <%
                                                                                                                                                    if(edu_list_size > 0)
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        {
                                                                                                                                                            ainfo = (TalentpoolInfo) edu_list.get(i);
                                                                                                                                                            if(ainfo != null)
                                                                                                                                                            {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><%= ainfo.getEduinstitute() != null ? ainfo.getEduinstitute() : "" %><%if((ainfo.getEduinstitute() != null && !ainfo.getEduinstitute().equals("")) && (ainfo.getLocationofInstitute() != null && !ainfo.getLocationofInstitute().equals(""))){%>,<%}%><%= ainfo.getLocationofInstitute() != null ? ainfo.getLocationofInstitute() : "" %></td>
                                                                                ...
                                                                                <td class="action_column">                                                                                        
                                                                                    ...
                                                                                    <% if (editper.equals("Y") && ainfo.getStatus() == 1 && dstatus != 4) {%><a href="javascript: modifyeducationForm('<%= ainfo.getEducationdetailId()%>');" class="edit_mode mr_15"><img src="../assets/images/pencil.png"/></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>

                                                                                    <span class="switch_bth">
                                                                                        <% if (deleteper.equals("Y") && dstatus != 4) {%>
                                                                                        <div class="form-check form-switch">
                                                                                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1){%> checked <% }%> <% if(!editper.equals("Y")) {%> disabled="true" <% } %>  onclick="javascript: deleteeducationForm('<%= ainfo.getEducationdetailId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                                        </div>
                                                                                        <%}%>
                                                                                    </span>
