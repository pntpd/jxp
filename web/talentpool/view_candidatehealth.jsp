...
<html lang="en">
    ...
    <%
            ...
            String file_path = talentpool.getMainPath("view_candidate_file");
                TalentpoolInfo healthinfo = null;
            if(session.getAttribute("CANDHEALTHINFO") != null)
            {
                healthinfo = (TalentpoolInfo)session.getAttribute("CANDHEALTHINFO");   
            }
            //For health list
    ...
    <html:form action="/talentpool/TalentpoolAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
        ...
        <html:hidden property="doModifyhealthdetail"/>
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('3');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="main-heading m_30">
                                                ...
                                                <div class="edit_btn pull_right float-end">
                                                    <% if(editper.equals("Y") && dstatus != 4) {%> <a href="javascript: modifyhealthForm();"><img src="../assets/images/edit.png"/></a> <% } %>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">	
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12 text-left flex-end align-items-end edit_sec">
                                                <ul class="resume_attach">
                                                    ...
                                                    <li><a href="javascript:;" class="attache_btn"><i class="fas fa-paperclip"></i> Attachment <span class="attach_number"> <%=talentpool.changeNum(1,3)%></span></a></li>
                                                    <li>
