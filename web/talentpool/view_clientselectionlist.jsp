...
<html lang="en">
    ...
    <%
            ...
            if(request.getAttribute("CLIENTSELHISTLIST") != null)
                compliance_list = (ArrayList) request.getAttribute("CLIENTSELHISTLIST");
        ...
        <html:form action="/talentpool/TalentpoolAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="toggled-off usefool_tool">
                                        ...
                                        <div class="toggle-content">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="javascript: exporttoexcelnew('15');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                                                        ...
                                                                        <table class="table table-striped mb-0">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th width="10%">Selection Status</th>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <%if(ainfo.getSflag() < 3 && ainfo.getOflag() <= 0){%>
                                                                                    <td class="action_column text-center"><a href="javascript:;" onclick = " javascript: getselectionmodal('<%= ainfo.getShortlistId()%>','<%= ainfo.getMaillogId()%>','<%= ainfo.getSflag()%>','<%= ainfo.getUsertype()%>','<%= ainfo.getOflag()%>')" data-bs-toggle="modal" data-bs-target="#view_pdf"><img src="../assets/images/view.png"/><br/></a></td>
                                                                                    <%} else if(ainfo.getSflag() >= 3 && ainfo.getOflag() <= 0){%>
                                                                                    <td class="action_column text-center"><a href="javascript:;" onclick = " javascript: getselectionmodal('<%= ainfo.getShortlistId()%>','<%= ainfo.getMaillogId()%>','<%= ainfo.getSflag()%>','<%= ainfo.getUsertype()%>','<%= ainfo.getOflag()%>')" data-bs-toggle="modal" data-bs-target="#view_mail"><img src="../assets/images/view.png"/><br/></a></td>
                                                                                    <%} else if(ainfo.getSflag() == 4 && ainfo.getOflag() < 3){%>
                                                                                    <td class="action_column text-center"><a href="javascript:;" onclick = " javascript: getselectionmodal('<%= ainfo.getShortlistId()%>','<%= ainfo.getMaillogId()%>','<%= ainfo.getSflag()%>','<%= ainfo.getUsertype()%>','<%= ainfo.getOflag()%>')" data-bs-toggle="modal" data-bs-target="#view_pdf"><img src="../assets/images/view.png"/><br/></a></td>
                                                                                    <%} else if(ainfo.getSflag() == 4 && ainfo.getOflag() >= 3){%>
                                                                                    <td class="action_column text-center"><a href="javascript:;" onclick = " javascript: getselectionmodal('<%= ainfo.getShortlistId()%>','<%= ainfo.getMaillogId()%>','<%= ainfo.getSflag()%>','<%= ainfo.getUsertype()%>','<%= ainfo.getOflag()%>')" data-bs-toggle="modal" data-bs-target="#view_mail"><img src="../assets/images/view.png"/><br/></a></td>
                                                                                    <%}%>
                                                                                ...
                                                                                {
                                                                                %>
                                                                                <tr><td colspan='7'>No client selection details available.</td></tr>
                                                                                <%
                                                                                }
                                                                                %>
                                                                            </tbody>
            ...
            <div id="view_pdf" class="modal fade" tabindex="-1" data-bs-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content" id="csmodel">
