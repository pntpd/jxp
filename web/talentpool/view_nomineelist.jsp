...
<html lang="en">
    ...
    <%
            ...
            if(request.getSession().getAttribute("MODULEPER_LIST") != null)
                ...
                ArrayList nominee_list = new ArrayList();
            if(request.getAttribute("CANDNOMINEELIST") != null)
                nominee_list = (ArrayList) request.getAttribute("CANDNOMINEELIST");
            int nominee_list_size = nominee_list.size();
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('25');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="main-heading">
                                                ...
                                                <div class="pull_right float-end">
                                                    <% if(addper.equals("Y") && dstatus != 4) {%><a href="javascript: modifynomineedetailForm(-1);" class="add_btn mr_25"><i class="mdi mdi-plus"></i></a><% } %>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12" id="printArea">
                                            <div class="table-responsive table-detail">
                                                <table class="table table-striped mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th width="%">Nominee Name</th>
                                                            <th width="%">Nominee Contact Number</th>
                                                            <th width="%">Nominee Relation</th>
                                                            <th width="%" class="text-right">Actions</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <%
                                                            if(nominee_list_size > 0)
                                                            {
                                                                TalentpoolInfo ainfo;
                                                                for(int i = 0; i < nominee_list_size; i++)
                                                                {
                                                                    ainfo = (TalentpoolInfo) nominee_list.get(i);
                                                                    if(ainfo != null)
                                                                    {
                                                                       
                                                        %>
                                                        <tr>
                                                            <td><%= ainfo.getNomineeName() != null ? ainfo.getNomineeName() : "" %></td>
                                                            <td><%= ainfo.getNomineeContactno() != null ? ainfo.getNomineeContactno() : "" %></td>
                                                            <td><%= ainfo.getNomineeRelation() != null ? ainfo.getNomineeRelation() : "" %></td>
                                                            <td class="action_column">
                                                                <% if (editper.equals("Y") && ainfo.getStatus() == 1 && dstatus != 4) {%><a href="javascript: modifynomineedetailForm('<%= ainfo.getNomineedetailId()%>');" class=" mr_15"><img src="../assets/images/pencil.png"/></a><% } else {%><a href='javascript:;' ><span style='width: 35px;'>&nbsp;</span></a><%}%>

                                                                <span class="switch_bth">         
                                                                    <% if (deleteper.equals("Y") && dstatus != 4) {%>
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault_<%=(i)%>" <% if( ainfo.getStatus() == 1){%>checked<% }%> onclick="javascript: deletenomineeForm('<%= ainfo.getNomineedetailId()%>', '<%= ainfo.getStatus()%>');"/>
                                                                    </div>
                                                                    <%}%>
                                                                </span>
                                                            </td>
                                                        ...
                                                        <%
                                                                                                                                ...
                                                                                                                                {
                                                        %>
                                                        <tr><td colspan='6'>No nominee details available.</td></tr>
                                                        <%
                                                                                                                                }
                                                        %>
                                                    </tbody>
