...
<html lang="en">
    ...
    <%
            ...
            if(request.getAttribute("APPRAISALLIST") != null)
                list = (ArrayList) request.getAttribute("APPRAISALLIST");
    ...
    <html:form action="/talentpool/TalentpoolAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
        <html:hidden property="doAddAppraisaldetail"/>
                                ...
                                <div class="toggled-off usefool_tool">
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript: exporttoexcelnew('28');"><img src="../assets/images/export-data.png"/> Export Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="main-heading">
                                                ...
                                                <div class="pull_right float-end">
                                                    ...
                                                    <a href="javascript: modifyAppraisalForm(-1);" class="add_btn mr_25"><i class="mdi mdi-plus"></i> </a>
                                                    <% } %>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 form_group">
                                                <div class="table-responsive table-detail">
                                                    <table class="table table-striped mb-0">
                                                        <thead>
                                                            <tr>
                                                                <th width="%">New Position</th>
                                                                <th width="%">Position Earlier</th>
                                                                <th width="%">Salary Effective from Date</th>
                                                                <th width="%">Salary Effective To Date</th>
                                                                <th width="%">Remarks</th>
                                                                <th width="%" class="text-right">Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <%
                                                            ...
                                                            %>
                                                            <tr>
                                                                <td><%= info.getPosition2() != null ? info.getPosition2() : ""%></td>
                                                                ...
                                                                <td><%= info.getRemarks() != null && !info.getRemarks().equals("") ? info.getRemarks() : "NA" %></td>     
                                                                <td class="action_column">
                                                                    <% if(!info.getFilename().equals("")) {%>
                                                                        <a href="javascript:;" class="mr_15" data-bs-toggle="modal" data-bs-target="#view_pdf" onclick="javascript:setIframe('<%=file_path+info.getFilename() %>');">
                                                                        <img src="../assets/images/attachment.png"/> </a><% } else { %>
                                                                        <a href='javascript:;'><span style='width: 35px;'>&nbsp;</span></a>
                                                                    <% } %>
                                                                    <a href="javascript:;" class="mr_15" data-bs-toggle="modal" data-bs-target="#client_position" onclick="javascript: getAppraisalHistory('<%=info.getAppraisalId() %>');"><img src="../assets/images/info.png"/> </a>
                                                                </td>
                                                            </tr>    
                                                            <%
                                                                    }
                                                            ...
                                                            %>
                                                            <tr><td colspan='6'>No appraisal details available.</td></tr>
                                                            <%
                                                                }
                                                            %>
                                                        </tbody>
        ...
        <div id="client_position" class="modal fade client_position appr_history" tabindex="-1" data-bs-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12" id="appHistory">
                            </div>
                        </div>
                    </div>
                </div>
