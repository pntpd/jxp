...
<html lang="en">
    ...
    <%
            ...
            String filename = "";
            if (session.getAttribute("OFFSHOREFILE") != null)
            {
                filename = (String)session.getAttribute("OFFSHOREFILE");
                if(filename != null && !filename.equals(""))
                    filename = talentpool.getMainPath("view_offshore_file")+filename;
            }
    ...
    <html:form action="/talentpool/TalentpoolAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
        <html:hidden property="doaddoffshoredetail"/>
        <html:hidden property="doSaveoffshoredetail"/>
        <html:hidden property="doModifyoffshoredetail"/>
        <html:hidden property="doDeleteoffshoredetail"/>
        <html:hidden property="offshoreId"/>
        <html:hidden property="offshorefilehidden" />
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="body-background">
                                    <div class="row d-none1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Date<span class="required"> *</span></label>
                                                <div class="input-daterange input-group">
                                                    <html:text property="date" styleId="date" styleClass="form-control add-style wesl_dt date-add" />
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Select Client<span class="required">*</span></label>
                                                <html:select property="clientId" styleClass="form-select" onchange="javascript: setAssetsOff();">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Remark Type<span class="required">*</span></label>
                                                <html:select property="remarktypeId" styleId="remarktypeId" styleClass="form-select">
                                                    <html:optionsCollection filter="false" property="remarktypes" label="ddlLabel" value="ddlValue">
                                                    </html:optionsCollection>
                                                </html:select>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 form_group">
                                                <label class="form_label">Description<span class="required">*</span></label>
                                                <html:textarea property="remark" styleId="remark" styleClass="form-control" rows="4"/>
                                                <script type="text/javascript">
                                                    document.getElementById("remark").setAttribute('placeholder', '');
                                                    document.getElementById("remark").setAttribute('maxlength', '1000');
                                                </script>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">File(if any) (.jpeg, .jpg, .png, .pdf)</label>                                                   
                                                <html:file property="offshorefile" styleId="upload1" onchange="javascript: setClass('1');"/>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12" id="submitdiv">
                                        <a href="javascript: submitOffshoreform();" class="save_btn"><img src="../assets/images/save.png"/> Save</a>
                                        <a href="javascript:openTab('23');" class="cl_btn"><i class="ion ion-md-close"></i> Close</a>
                                    </div>
                                </div>
                            </div>
                        </div>
