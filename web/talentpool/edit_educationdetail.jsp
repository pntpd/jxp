...
<html lang="en">
    ...
    <html:form action="/talentpool/TalentpoolAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
        ...
        <html:hidden property="educationhiddenfile"/>
        <html:hidden property="workinghiddenfile"/>
        <html:hidden property="currentDate"/>
        <html:hidden property="backgroundofstudy"/>
        <html:hidden property="fieldofstudy"/>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    <label class="form_label">Kind<span class="required">*</span></label>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    <label class="form_label">Degree<span class="required">*</span></label>
...
<!--                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    <label class="form_label">Background of Study</label>
                                                    <html property="backgroundofstudy" styleId="backgroundofstudy" styleClass="form-control" maxlength="100"/>
                                                    <script type="text/javascript">
                                                        document.getElementById("backgroundofstudy").setAttribute('placeholder', '');
                                                    </script>
                                                </div>-->
...
<!--                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    ...
                                                    <html property="fieldofstudy" styleId="fieldofstudy" styleClass="form-control" maxlength="100"/>
                                                    <script type="text/javascript">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    ...
                                                    <html:file property="educationfile" styleId="upload1" onchange="javascript: setClass('1');"/>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    <label class="form_label">Highest Qualification</label>
                                                    <div class="full_width">
                                                        <div class="form-check permission-check">
                                                            <html:checkbox property="highestqualification" value = "1" styleClass="form-check-input"  styleId="switch1"  />
                                                            <span class="ml_10"><b>This is my highest qualification.</b></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12" id="submitdiv">
                                                <a href="javascript: submiteducationform();" class="save_btn"><img src="../assets/images/save.png"> Save</a>
                                                <a href="javascript: openTab('9');" class="cl_btn"><i class="ion ion-md-close"></i> Close</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
