...
<%
        ...
        PdeptInfo info = null;
        if(request.getAttribute("PDEPT_DETAIL") != null)
            info = (PdeptInfo)request.getAttribute("PDEPT_DETAIL");
%>  
<head>
    <meta charset="utf-8">
...
<html:form action="/pdept/PdeptAction.do" onsubmit="return false;" styleClass="form-horizontal">
            ...
            <div class="page-content">
                <div class="row head_title_area">
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start"><a href="javascript: goback();" class="back_arrow"><img  src="../assets/images/back-arrow.png"/> View Department</a></div>
                        <div class="float-end">                            
...
%>
                                    <div class="row col-lg-12">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
                                            ...
                                            <span class="form-control"><%= pdept.getStatusById(info.getStatus()) %></span>
                                        </div>
                                    </div>
