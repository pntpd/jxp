...
<html:form action="/pdept/PdeptAction.do" onsubmit="return false;" styleClass="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-xl-12">
                        <div class="float-start">
                            ...
                            <img  src="../assets/images/back-arrow.png"/> 
                                <c:choose>
                                    <c:when test="${pdeptForm.pdeptId <= 0}">
